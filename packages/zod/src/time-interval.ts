 ...
 */
export const timeIntervals = ["DAILY", "WEEKLY", "MONTHLY", "QUARTERLY", "YEARLY"] as const;
 ...
 * ```
 */
export const timeInterval = () => z.enum(timeIntervals).describe("Time interval for scheduling");
