...
describe("convertPostfixToInfix", () => {
  ...
  it("should return empty array for invalid NOT expression", () => {
    const postfix = [{ nodeType: ExpressionTypeEnum.NOT, value: 0n }];
    expect(convertPostfixToInfix(postfix)).toEqual([]);
  });

  it("should return empty array for invalid OR expression with single operand", () => {
    const postfix = [
      { nodeType: ExpressionTypeEnum.TOPIC, value: 1n },
      { nodeType: ExpressionTypeEnum.OR, value: 0n },
    ];
  ...
  it("should handle complex expression with parentheses for OR expression", () => {
    const postfix = [
      { nodeType: ExpressionTypeEnum.TOPIC, value: 1n },
      { nodeType: ExpressionTypeEnum.TOPIC, value: 2n },
      { nodeType: ExpressionTypeEnum.OR, value: 0n },
...
describe("expression node coverage tests", () => {
  ...
  it("should handle edge case in convertPostfixToInfix with parentheses for complex left operand", () => {
    const postfix = [
      { nodeType: ExpressionTypeEnum.TOPIC, value: 1n },
      { nodeType: ExpressionTypeEnum.TOPIC, value: 2n },
      { nodeType: ExpressionTypeEnum.AND, value: 0n },
  ...
  it("should handle edge case in convertPostfixToInfix with parentheses for complex right operand", () => {
    const postfix = [
      { nodeType: ExpressionTypeEnum.TOPIC, value: 1n },
      { nodeType: ExpressionTypeEnum.TOPIC, value: 2n },
      { nodeType: ExpressionTypeEnum.TOPIC, value: 3n },
  ...
  it("should handle NOT precedence in convertInfixToPostfix", () => {
    const infix: ExpressionWithGroups = [
      { nodeType: ExpressionTypeEnum.TOPIC, value: 1n },
      { nodeType: ExpressionTypeEnum.NOT, value: 0n },
      { nodeType: ExpressionTypeEnum.AND, value: 0n },
  ...
  it("should handle operator precedence breaks in convertInfixToPostfix", () => {
    const infix: ExpressionWithGroups = [
      { nodeType: ExpressionTypeEnum.TOPIC, value: 1n },
      { nodeType: ExpressionTypeEnum.OR, value: 0n },
      { nodeType: ExpressionTypeEnum.TOPIC, value: 2n },
  ...
  it("should handle invalid NOT without operand in convertPostfixToInfix", () => {
    const postfix = [
      { nodeType: ExpressionTypeEnum.TOPIC, value: 1n },
      { nodeType: ExpressionTypeEnum.NOT, value: 0n },
      { nodeType: ExpressionTypeEnum.NOT, value: 0n },
  ...
  it("should handle invalid binary operator without enough operands", () => {
    const postfix = [{ nodeType: ExpressionTypeEnum.AND, value: 0n }];
    const result = convertPostfixToInfix(postfix);
    expect(result).toEqual([]);
  });
