...
import type { AccessControlRoles } from "../fragments/the-graph/access-control-fragment";
...
export const SYSTEM_MANAGER_ROLE = new RoleConfig("SYSTEM_MANAGER_ROLE", "systemManager");
export const IDENTITY_MANAGER_ROLE = new RoleConfig("IDENTITY_MANAGER_ROLE", "identityManager");
export const TOKEN_MANAGER_ROLE = new RoleConfig("TOKEN_MANAGER_ROLE", "tokenManager");
export const COMPLIANCE_MANAGER_ROLE = new RoleConfig("COMPLIANCE_MANAGER_ROLE", "complianceManager");
export const ADDON_MANAGER_ROLE = new RoleConfig("ADDON_MANAGER_ROLE", "addonManager");
export const CLAIM_POLICY_MANAGER_ROLE = new RoleConfig("CLAIM_POLICY_MANAGER_ROLE", "claimPolicyManager");
export const AUDITOR_ROLE = new RoleConfig("AUDITOR_ROLE", "auditor");

// --- System Roles (ATKSystemRoles) ---
export const SYSTEM_MODULE_ROLE = new RoleConfig("SYSTEM_MODULE_ROLE", "systemModule");
export const IDENTITY_REGISTRY_MODULE_ROLE = new RoleConfig("IDENTITY_REGISTRY_MODULE_ROLE", "identityRegistryModule");
...
export const TOKEN_FACTORY_MODULE_ROLE = new RoleConfig("TOKEN_FACTORY_MODULE_ROLE", "tokenFactoryModule");
export const ADDON_FACTORY_REGISTRY_MODULE_ROLE = new RoleConfig(
  "ADDON_FACTORY_REGISTRY_MODULE_ROLE",
  "addonRegistryModule"
);
export const ADDON_FACTORY_MODULE_ROLE = new RoleConfig("ADDON_FACTORY_MODULE_ROLE", "addonModule");

// --- Asset Roles (ATKAssetRoles) ---
export const GOVERNANCE_ROLE = new RoleConfig("GOVERNANCE_ROLE", "governance");
export const SUPPLY_MANAGEMENT_ROLE = new RoleConfig("SUPPLY_MANAGEMENT_ROLE", "supplyManagement");
...
export const CAP_MANAGEMENT_ROLE = new RoleConfig("CAP_MANAGEMENT_ROLE", "capManagement");
export const COMPLIANCE_ADMIN_ROLE = new RoleConfig("COMPLIANCE_ADMIN_ROLE", "complianceAdmin");
export const FORCED_TRANSFER_ROLE = new RoleConfig("FORCED_TRANSFER_ROLE", "forcedTransfer");
...
export const TOKEN_ADMIN_ROLE = new RoleConfig("TOKEN_ADMIN_ROLE", "tokenAdmin");
export const VERIFICATION_ADMIN_ROLE = new RoleConfig("VERIFICATION_ADMIN_ROLE", "verificationAdmin");

// --- Addon-Specific Roles ---
export const FUNDS_MANAGER_ROLE = new RoleConfig("FUNDS_MANAGER_ROLE", "fundsManager");
...
export const GLOBAL_LIST_MANAGER_ROLE = new RoleConfig("GLOBAL_LIST_MANAGER_ROLE", "globalListManager");
...
export function getRoleByFieldName(fieldName: AccessControlRoles): RoleConfig | undefined {
