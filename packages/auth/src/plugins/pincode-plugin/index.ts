...
import { removePincode, setPincode, updatePincode } from "./queries";
      ...
      enablePincode: createAuthEndpoint(
        "/pincode/enable",
        {
          ...
          body: z.object({
            ...
            password: z
              .string()
              .describe("User password (only required if the user has done the initial onboarding)")
              .optional(),
          }),
          ...
          metadata: {
            openapi: {
              ...
              description: "Use this endpoint to enable pincode. This will set the pincode for the user's account.",
              responses: {
                200: {
        ...
        "/pincode/update",
        {
          ...
          metadata: {
            openapi: {
              ...
              description: "Use this endpoint to update pincode. This will update the pincode for the user's account.",
              responses: {
                200: {
                  description: "Successful response",
                  content: {
