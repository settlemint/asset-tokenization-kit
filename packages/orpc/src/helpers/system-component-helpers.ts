...
function hasAccessControl(value: unknown): value is { accessControl: unknown } {
  return typeof value === "object" && value !== null && "accessControl" in value;
}
 ...
 */
export function parseSystemComponent(component: unknown): { id: EthereumAddress; accessControl: AccessControl } | null {
  if (!component) {
