 ...
 */
export function validateNonEmptyArrays(arrays: Record<string, unknown[]>, operation: string): void {
 ...
 */
export function validateBatchArrays(arrays: Record<string, unknown[]>, operation: string, maxLength = 100): void {
