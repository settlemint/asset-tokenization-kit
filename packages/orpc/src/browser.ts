...
const getORPCClient = createIsomorphicFn()
  ...
  .client((): RouterClient<typeof router> => {
    // This code only runs on the client side where window is available
    const windowObj = globalThis as typeof globalThis & { location?: { origin: string } };
 ...
 * ```
 */
const client = getORPCClient() as ContractRouterClient<typeof contract>;
