...
import { StatsBondStatusInputSchema, StatsBondStatusOutputSchema } from "./bond-status.schema";
...
export const statsBondStatusContract = baseContract
  .route({
    ...
    successDescription: "Bond status statistics including denomination asset information",
