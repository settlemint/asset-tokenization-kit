...
import type { ActionsListResponse } from "@/routes/actions/routes/actions.list.schema";
 ...
 */
export const actions = authRouter.token.actions.handler(async ({ input, context }): Promise<ActionsListResponse> => {
