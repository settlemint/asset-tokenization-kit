...
import { predictAddressHandlerMap } from "@/routes/system/token-factory/helpers/predict-handlers/handler-map";

export const factoryPredictAddress = portalRouter.system.tokenFactoryPredictAddress.handler(
