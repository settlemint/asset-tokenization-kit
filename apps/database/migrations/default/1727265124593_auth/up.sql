...
ALTER TABLE ONLY private_keys
    ADD CONSTRAINT private_keys_pkey PRIMARY KEY (address);
...
ALTER TABLE ONLY private_keys
    ADD CONSTRAINT "private_keys_userId_fkey" FOREIGN KEY ("userId") REFERENCES public.users(id) ON UPDATE RESTRICT ON DELETE CASCADE;

ALTER TABLE ONLY user_roles
    ADD CONSTRAINT "user_roles_userId_fkey" FOREIGN KEY ("userId") REFERENCES public.users(id) ON UPDATE RESTRICT ON DELETE CASCADE;
