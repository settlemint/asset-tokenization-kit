...
const limitNameLength = (name: string, maxLength = 50): string => {
...
const _fundAssetClasses = ['Equity', 'Fixed', 'Multi', 'Global'];
...
export function generateFutureDateTimeString(hoursToAdd = 24): string {
  const now = new Date();
...
export const bondData = {
  ...
  isin: `US${getRandomInt(1_000_000_000, 9_999_999_999)}`,
