...
TOKENIZED_DEPOSIT_FACTORY_ADDRESS=$(jq -r '."TokenizedDepositFactoryModule#TokenizedDepositFactory"' ../contracts/ignition/deployments/asset-tokenization-local/deployed_addresses.json)
