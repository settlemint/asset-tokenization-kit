...
- **CountryAllowList** (`CountryAllowModule.sol`)
  - TODO: Describe allowed/blocked lists, bulk import, and testing.
- **IdentityVerification** (`IdentityModule.sol`)
  - TODO: Map verification levels to claim topics and enforcement.
- **InvestorCount** (`MaxBalanceModule.sol`)
  - TODO: Configure holder caps, exemptions, and monitoring.
...
- **SupplyCap** (`SupplyCapModule.sol`)
  - TODO: Establish caps, adjustment process, and oversight.
- **TransferLimit** (`TransferLimitModule.sol`)
  - TODO: Configure daily/monthly limits, overrides.
- **AddressBlocking** (`BlocklistModule.sol`)
  - TODO: Integrate sanctions lists, manual overrides.
- **AccreditedInvestor** (`AccreditedModule.sol`)
  - TODO: Verify accreditation claims, expiry handling.
- **Custom Modules**
...
- `kit/contracts/contracts/smart/compliance-modules/` — source code.
