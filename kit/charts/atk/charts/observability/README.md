...
|------------|------|---------|
| https://grafana.github.io/helm-charts | alloy | 1.1.1 |
| https://grafana.github.io/helm-charts | grafana | 9.2.7 |
...
| alloy.configReloader.image.registry | string | `"harbor.settlemint.com/ghcr.io"` |  |
...
| alloy.image.registry | string | `"harbor.settlemint.com/docker.io"` |  |
...
| grafana.global.imageRegistry | string | `"harbor.settlemint.com/docker.io"` |  |
...
| kube-state-metrics.image.registry | string | `"harbor.settlemint.com/registry.k8s.io"` |  |
...
| loki.global.image.registry | string | `"harbor.settlemint.com/docker.io"` |  |
...
| loki.memcached.image.repository | string | `"harbor.settlemint.com/docker.io/library/memcached"` |  |
| loki.memcachedExporter.image.repository | string | `"harbor.settlemint.com/docker.io/prom/memcached-exporter"` |  |
...
| metrics-server.image.repository | string | `"harbor.settlemint.com/registry.k8s.io/metrics-server/metrics-server"` |  |
...
| prometheus-node-exporter.global.imageRegistry | string | `"harbor.settlemint.com/quay.io"` |  |
| prometheus-node-exporter.image.registry | string | `"harbor.settlemint.com/quay.io"` |  |
...
| prometheus-node-exporter.kubeRBACProxy.image.registry | string | `"harbor.settlemint.com/quay.io"` |  |
...
| tempo.tempo.repository | string | `"harbor.settlemint.com/docker.io/grafana/tempo"` |  |
...
| tempo.tempoQuery.repository | string | `"harbor.settlemint.com/docker.io/grafana/tempo-query"` |  |
| victoria-metrics-single.enabled | bool | `true` |  |
| victoria-metrics-single.global.image.registry | string | `"harbor.settlemint.com/docker.io"` |  |
