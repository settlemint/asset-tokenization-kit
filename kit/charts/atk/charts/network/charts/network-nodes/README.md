...
| config | object | `{"bonsaiLimitTrieLogsEnabled":false,"cacheLastBlocks":1024,"dataStorageFormat":"FOREST","genesisFile":"/etc/besu/genesis.json","graphql":{"corsOrigins":["all"],"enabled":true,"host":"0.0.0.0"},"hostAllowlist":["*"],"http":{"api":["DEBUG","ETH","ADMIN","WEB3","IBFT","NET","TRACE","QBFT","PERM","TXPOOL","PLUGINS"],"authenticationEnabled":false,"corsOrigins":["all"],"enabled":true,"host":"0.0.0.0","maxActiveConnections":2000,"maxBatchSize":512,"maxRequestContentLength":524288000},"logFormat":"plain","logging":"INFO","metrics":{"categories":["BLOCKCHAIN","ETHEREUM","EXECUTORS","JVM","NETWORK","PEERS","PROCESS","PRUNER","RPC","SYNCHRONIZER","TRANSACTION_POOL"],"enabled":true,"host":"0.0.0.0"},"minGasPrice":0,"p2p":{"discoveryEnabled":true,"enabled":true,"interface":"0.0.0.0","maxPeers":25,"staticNodesFile":"/etc/besu/static-nodes.json"},"privateKeyFilename":"privateKey","randomPeerPriorityEnabled":true,"receiptCompactionEnabled":true,"remoteConnectionsLimitEnabled":false,"revertReasonEnabled":true,"rpc":{"txFeecap":0},"sync":{"minPeers":1,"mode":"FULL"},"txPool":{"enableSaveRestore":true,"limitByAccountPercentage":1,"maxSize":100000,"noLocalPriority":true,"type":"SEQUENCED"},"ws":{"api":["DEBUG","ETH","ADMIN","WEB3","IBFT","NET","TRACE","QBFT","PERM","TXPOOL","PLUGINS"],"authenticationEnabled":false,"enabled":true,"host":"0.0.0.0","maxActiveConnections":2000,"maxFrameSize":2097152}}` | Core Besu configuration persisted as besu.conf for both validators and RPC nodes. |
...
| config.graphql | object | `{"corsOrigins":["all"],"enabled":true,"host":"0.0.0.0"}` | GraphQL server configuration. |
...
| config.http | object | `{"api":["DEBUG","ETH","ADMIN","WEB3","IBFT","NET","TRACE","QBFT","PERM","TXPOOL","PLUGINS"],"authenticationEnabled":false,"corsOrigins":["all"],"enabled":true,"host":"0.0.0.0","maxActiveConnections":2000,"maxBatchSize":512,"maxRequestContentLength":524288000}` | HTTP JSON-RPC server configuration. |
...
| config.metrics | object | `{"categories":["BLOCKCHAIN","ETHEREUM","EXECUTORS","JVM","NETWORK","PEERS","PROCESS","PRUNER","RPC","SYNCHRONIZER","TRANSACTION_POOL"],"enabled":true,"host":"0.0.0.0"}` | Prometheus metrics export configuration. |
