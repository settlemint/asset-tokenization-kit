...
| image.repository | string | `"harbor.settlemint.com/ghcr.io/settlemint/asset-tokenization-kit"` |  |
...
| initContainer.graphQLCheck.image.registry | string | `"harbor.settlemint.com/docker.io"` |  |
...
| job.initContainer.cloneRepo.image.registry | string | `"harbor.settlemint.com/docker.io"` |  |
...
| job.initContainer.hasuraCheck.image.repository | string | `"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"` |  |
