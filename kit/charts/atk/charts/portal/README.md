...
| image | object | `{"digest":"","pullPolicy":"IfNotPresent","pullSecrets":[],"registry":"ghcr.io","repository":"ghcr.io/settlemint/btp-scs-portal","tag":"8.5.15"}` | Portal image |
...
| image.repository | string | `"ghcr.io/settlemint/btp-scs-portal"` | Portal image repository |
| image.tag | string | `"8.5.15"` | Portal image tag (immutable tags are recommended) |
