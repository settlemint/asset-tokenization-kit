...
| image | object | `{"digest":"","pullPolicy":"IfNotPresent","pullSecrets":[],"registry":"ghcr.io","repository":"settlemint/btp-scs-portal","tag":"8.5.19"}` | Portal image |
...
| image.tag | string | `"8.5.19"` | Portal image tag (immutable tags are recommended) |
