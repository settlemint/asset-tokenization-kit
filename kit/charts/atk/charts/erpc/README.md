...
| global.securityContexts.pod | object | `{"fsGroup":101337,"runAsNonRoot":true,"seccompProfile":{"type":"RuntimeDefault"}}` | Pod security context defaults shared across charts |
