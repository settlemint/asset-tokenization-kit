...
| blockscout.image | object | `{"pullPolicy":"IfNotPresent","repository":"harbor.settlemint.com/ghcr.io/blockscout/blockscout","tag":"9.0.2"}` | Blockscout backend image configuration (object) |
| blockscout.image.pullPolicy | string | `"IfNotPresent"` | Blockscout backend image pull policy |
| blockscout.image.repository | string | `"harbor.settlemint.com/ghcr.io/blockscout/blockscout"` | Blockscout backend image repository (object) |
