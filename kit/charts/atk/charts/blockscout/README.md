...
| blockscout.openShiftRoute.alternateBackends | list | `[]` |  |
| blockscout.openShiftRoute.annotations | object | `{}` |  |
| blockscout.openShiftRoute.enabled | bool | `false` |  |
| blockscout.openShiftRoute.host | string | `"explorer.k8s.orb.local"` |  |
| blockscout.openShiftRoute.path | string | `"/api"` |  |
| blockscout.openShiftRoute.port.targetPort | string | `"http"` |  |
| blockscout.openShiftRoute.tls | string | `nil` |  |
| blockscout.openShiftRoute.to.weight | int | `100` |  |
| blockscout.openShiftRoute.wildcardPolicy | string | `"None"` |  |
...
| frontend.openShiftRoute.alternateBackends | list | `[]` |  |
| frontend.openShiftRoute.annotations | object | `{}` |  |
| frontend.openShiftRoute.enabled | bool | `false` |  |
| frontend.openShiftRoute.host | string | `"explorer.k8s.orb.local"` |  |
| frontend.openShiftRoute.path | string | `"/"` |  |
| frontend.openShiftRoute.port.targetPort | string | `"http"` |  |
| frontend.openShiftRoute.tls | string | `nil` |  |
| frontend.openShiftRoute.to.weight | int | `100` |  |
| frontend.openShiftRoute.wildcardPolicy | string | `"None"` |  |
