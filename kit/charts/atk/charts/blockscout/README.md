...
| frontend.image | object | `{"pullPolicy":"IfNotPresent","repository":"harbor.settlemint.com/ghcr.io/blockscout/frontend","tag":"v2.3.3"}` | Blockscout frontend image configuration |
