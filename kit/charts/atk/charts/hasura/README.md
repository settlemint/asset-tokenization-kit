...
|initContainers[0]|string|`{"command":["/usr/bin/wait-for-it","postgresql:5432","-t","120"],"image":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit:v7.7.13","imagePullPolicy":"IfNotPresent","name":"wait-for-postgresql","resources":{"limits":{"cpu":"300m","memory":"64Mi"},"requests":{"cpu":"10m","memory":"32Mi"}}}`|Container name|
|initContainers[0].command|list|-|Container command|
|initContainers[0].image|string|`"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit:v7.7.13"`|Container image|
