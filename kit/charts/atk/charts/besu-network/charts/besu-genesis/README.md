...
| generation.enabled | bool | `true` |  |
| generation.manual.bootnodes | list | `[]` |  |
| generation.manual.genesisJson | string | `""` |  |
| generation.manual.staticNodes | list | `[]` |  |
| generation.manual.validators | list | `[]` |  |
