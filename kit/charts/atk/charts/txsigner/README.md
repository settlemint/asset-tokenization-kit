...
| image | object | `{"digest":"","pullPolicy":"IfNotPresent","pullSecrets":[],"registry":"harbor.settlemint.com/\"ghcr.io\"","repository":"settlemint/btp-signer","tag":"7.13.1"}` | TxSigner image |
...
| image.tag | string | `"7.13.1"` | TxSigner image tag (immutable tags are recommended) |
...
| initContainers | list | `[{"command":["/usr/bin/wait-for-it","postgresql-pgpool:5432","-t","0"],"image":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit:v7.7.5","name":"wait-for-postgres"}]` | Init containers configuration |
