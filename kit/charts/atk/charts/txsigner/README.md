...
| image | object | `{"digest":"","pullPolicy":"IfNotPresent","pullSecrets":[],"registry":"ghcr.io","repository":"settlemint/btp-signer","tag":"7.15.1"}` | TxSigner image |
...
| image.tag | string | `"7.15.1"` | TxSigner image tag (immutable tags are recommended) |
