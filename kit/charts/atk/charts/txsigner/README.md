...
| image | object | `{"digest":"","pullPolicy":"IfNotPresent","pullSecrets":[],"registry":"ghcr.io","repository":"ghcr.io/settlemint/btp-signer","tag":"7.13.4"}` | TxSigner image |
...
| image.repository | string | `"ghcr.io/settlemint/btp-signer"` | TxSigner image repository |
