...
| image | object | `{"digest":"","pullPolicy":"IfNotPresent","pullSecrets":[],"registry":"ghcr.io","repository":"ghcr.io/settlemint/btp-signer","tag":"7.13.5"}` | TxSigner image |
...
| image.tag | string | `"7.13.5"` | TxSigner image tag (immutable tags are recommended) |
