...
| erpc.openShiftRoute.alternateBackends | list | `[]` |  |
| erpc.openShiftRoute.annotations | object | `{}` |  |
| erpc.openShiftRoute.enabled | bool | `false` |  |
| erpc.openShiftRoute.host | string | `"rpc.k8s.orb.local"` |  |
| erpc.openShiftRoute.path | string | `"/"` |  |
| erpc.openShiftRoute.port.targetPort | string | `"http"` |  |
| erpc.openShiftRoute.tls | string | `nil` |  |
| erpc.openShiftRoute.to.weight | int | `100` |  |
| erpc.openShiftRoute.wildcardPolicy | string | `"None"` |  |
