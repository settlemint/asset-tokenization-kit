...
| blockscout.blockscout.image | object | `{"repository":"harbor.settlemint.com/ghcr.io/blockscout/blockscout"}` | Blockscout backend container image |
...
| blockscout.blockscout.initContainer | object | `{"tcpCheck":{"image":{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}}}` | Init container for database readiness |
| blockscout.blockscout.initContainer.tcpCheck | object | `{"image":{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}}` | TCP check for PostgreSQL |
| blockscout.blockscout.initContainer.tcpCheck.image | object | `{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}` | Wait-for-it utility image |
...
| blockscout.frontend | object | `{"enabled":true,"image":{"repository":"harbor.settlemint.com/ghcr.io/blockscout/frontend"},"ingress":{"className":"atk-nginx","enabled":true,"hostname":"explorer.k8s.orb.local"}}` | Blockscout frontend service configuration |
| blockscout.frontend.enabled | bool | `true` | Enable Blockscout frontend deployment |
| blockscout.frontend.image | object | `{"repository":"harbor.settlemint.com/ghcr.io/blockscout/frontend"}` | Blockscout frontend container image |
...
| dapp | object | `{"enabled":true,"image":{"repository":"harbor.settlemint.com/ghcr.io/settlemint/asset-tokenization-kit"},"ingress":{"enabled":true,"hosts":[{"host":"dapp.k8s.orb.local","paths":[{"path":"/","pathType":"ImplementationSpecific"}]}]},"initContainer":{"graphQLCheck":{"image":{"registry":"harbor.settlemint.com/docker.io"}},"tcpCheck":{"image":{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}}},"job":{"image":{"repository":"harbor.settlemint.com/docker.io/node"}},"resources":{},"secretEnv":{"BETTER_AUTH_URL":"https://dapp.k8s.orb.local","SETTLEMINT_BLOCKSCOUT_UI_ENDPOINT":"https://blockscout.k8s.orb.local/"}}` | DApp frontend application configuration |
| dapp.enabled | bool | `true` | Enable deployment of the Asset Tokenization Kit web application |
| dapp.image | object | `{"repository":"harbor.settlemint.com/ghcr.io/settlemint/asset-tokenization-kit"}` | DApp container image configuration |
...
| dapp.initContainer | object | `{"graphQLCheck":{"image":{"registry":"harbor.settlemint.com/docker.io"}},"tcpCheck":{"image":{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}}}` | Init containers for DApp startup dependencies |
| dapp.initContainer.graphQLCheck | object | `{"image":{"registry":"harbor.settlemint.com/docker.io"}}` | GraphQL endpoint readiness check |
| dapp.initContainer.graphQLCheck.image | object | `{"registry":"harbor.settlemint.com/docker.io"}` | curl utility for GraphQL health checks |
| dapp.initContainer.graphQLCheck.image.registry | string | `"harbor.settlemint.com/docker.io"` | OCI registry for curl image |
| dapp.initContainer.tcpCheck | object | `{"image":{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}}` | TCP check for backend services |
| dapp.initContainer.tcpCheck.image | object | `{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}` | Wait-for-it utility image |
...
| dapp.job | object | `{"image":{"repository":"harbor.settlemint.com/docker.io/node"}}` | Post-deployment job configuration for database migrations |
| dapp.job.image | object | `{"repository":"harbor.settlemint.com/docker.io/node"}` | Job container image |
...
| erpc | object | `{"enabled":true,"image":{"registry":"harbor.settlemint.com/ghcr.io"},"ingress":{"className":"atk-nginx","enabled":true,"hosts":[{"host":"rpc.k8s.orb.local","paths":[{"path":"/","pathType":"ImplementationSpecific"}]}]},"initContainer":{"tcpCheck":{"image":{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}}},"openShiftRoute":{"enabled":false,"host":"rpc.k8s.orb.local"},"resources":{},"tests":{"image":{"registry":"harbor.settlemint.com/docker.io"}}}` | ERPC Gateway configuration for RPC load balancing and caching |
| erpc.enabled | bool | `true` | Enable deployment of ERPC gateway |
| erpc.image | object | `{"registry":"harbor.settlemint.com/ghcr.io"}` | ERPC container image |
...
| erpc.initContainer | object | `{"tcpCheck":{"image":{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}}}` | Init container for startup dependency checks |
| erpc.initContainer.tcpCheck | object | `{"image":{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}}` | TCP readiness check |
| erpc.initContainer.tcpCheck.image | object | `{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}` | Wait-for-it utility image |
...
| erpc.tests | object | `{"image":{"registry":"harbor.settlemint.com/docker.io"}}` | Test container image for ERPC health checks |
| erpc.tests.image | object | `{"registry":"harbor.settlemint.com/docker.io"}` | Test image configuration |
...
| graph-node | object | `{"enabled":true,"image":{"repository":"harbor.settlemint.com/docker.io/graphprotocol/graph-node"},"ingress":{"annotations":{"nginx.ingress.kubernetes.io/rewrite-target":"/$1","nginx.ingress.kubernetes.io/use-regex":"true"},"className":"atk-nginx","enabled":true,"hosts":[{"host":"graph.k8s.orb.local","paths":[{"path":"/(.*)","pathType":"ImplementationSpecific"},{"path":"/ws/?(.*)","pathType":"ImplementationSpecific"},{"path":"/admin/?(.*)","pathType":"ImplementationSpecific"},{"path":"/indexer/?(.*)","pathType":"ImplementationSpecific"},{"path":"/graphman/?(.*)","pathType":"ImplementationSpecific"}]}]},"initContainer":{"image":{"repository":"harbor.settlemint.com/docker.io/kubesphere/kubectl"},"tcpCheck":{"image":{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}}},"openShiftRoute":{"enabled":false,"host":"graph.k8s.orb.local"}}` | The Graph Node configuration for blockchain indexing |
| graph-node.enabled | bool | `true` | Enable deployment of The Graph indexing protocol |
| graph-node.image | object | `{"repository":"harbor.settlemint.com/docker.io/graphprotocol/graph-node"}` | Graph Node container image |
...
| graph-node.initContainer | object | `{"image":{"repository":"harbor.settlemint.com/docker.io/kubesphere/kubectl"},"tcpCheck":{"image":{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}}}` | Init containers for Graph Node startup |
| graph-node.initContainer.image | object | `{"repository":"harbor.settlemint.com/docker.io/kubesphere/kubectl"}` | Kubernetes client utility for pre-deployment tasks |
...
| graph-node.initContainer.tcpCheck | object | `{"image":{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}}` | TCP check for dependencies |
| graph-node.initContainer.tcpCheck.image | object | `{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}` | Wait-for-it utility image |
...
| hasura | object | `{"enabled":true,"fullnameOverride":"hasura","image":{"pullPolicy":"IfNotPresent","registry":"harbor.settlemint.com/docker.io","repository":"hasura/graphql-engine","tag":"v2.48.6"},"ingress":{"hostName":"hasura.k8s.orb.local"}}` | Hasura GraphQL Engine configuration |
...
| hasura.image | object | `{"pullPolicy":"IfNotPresent","registry":"harbor.settlemint.com/docker.io","repository":"hasura/graphql-engine","tag":"v2.48.6"}` | Hasura container image configuration |
...
| ipfs | object | `{"cluster":{"image":{"registry":"harbor.settlemint.com/docker.io"}},"enabled":true,"ingress":{"hostnames":{"api":"ipfs-cluster.k8s.orb.local"}},"ipfs":{"config":{"api":{"httpHeaders":{"accessControlAllowOrigin":["https://ipfs-cluster.k8s.orb.local","http://ipfs-cluster.k8s.orb.local"]}}},"image":{"registry":"harbor.settlemint.com/docker.io"}},"tests":{"image":{"registry":"harbor.settlemint.com/docker.io"}}}` | IPFS Cluster deployment configuration |
| ipfs.cluster | object | `{"image":{"registry":"harbor.settlemint.com/docker.io"}}` | IPFS Cluster control-plane configuration overrides |
...
| ipfs.ipfs | object | `{"config":{"api":{"httpHeaders":{"accessControlAllowOrigin":["https://ipfs-cluster.k8s.orb.local","http://ipfs-cluster.k8s.orb.local"]}}},"image":{"registry":"harbor.settlemint.com/docker.io"}}` | IPFS peer configuration overrides |
| ipfs.ipfs.image.registry | string | `"harbor.settlemint.com/docker.io"` | OCI registry for the Kubo image |
| ipfs.tests | object | `{"image":{"registry":"harbor.settlemint.com/docker.io"}}` | Test pod image configuration |
| network | object | `{"enabled":true,"network-bootstrapper":{"artifacts":{"predeployed":{"image":{"registry":"harbor.settlemint.com/ghcr.io"}}},"image":{"repository":"harbor.settlemint.com/ghcr.io/settlemint/network-bootstrapper"},"initContainer":{"tcpCheck":{"image":{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}}}},"network-nodes":{"image":{"repository":"harbor.settlemint.com/docker.io/hyperledger/besu"},"initContainer":{"tcpCheck":{"image":{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}}},"persistence":{"size":"20Gi"}}}` | Blockchain network infrastructure configuration |
| network.enabled | bool | `true` | Enable deployment of the blockchain network (validators and RPC nodes) |
| network.network-bootstrapper | object | `{"artifacts":{"predeployed":{"image":{"registry":"harbor.settlemint.com/ghcr.io"}}},"image":{"repository":"harbor.settlemint.com/ghcr.io/settlemint/network-bootstrapper"},"initContainer":{"tcpCheck":{"image":{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}}}}` | Network bootstrapper job configuration for genesis and initial setup |
| network.network-bootstrapper.artifacts | object | `{"predeployed":{"image":{"registry":"harbor.settlemint.com/ghcr.io"}}}` | Pre-deployed contract artifacts configuration |
| network.network-bootstrapper.artifacts.predeployed | object | `{"image":{"registry":"harbor.settlemint.com/ghcr.io"}}` | Configuration for pre-deployed smart contracts in genesis |
| network.network-bootstrapper.artifacts.predeployed.image | object | `{"registry":"harbor.settlemint.com/ghcr.io"}` | Image containing pre-deployed contract bytecode |
...
| network.network-bootstrapper.image | object | `{"repository":"harbor.settlemint.com/ghcr.io/settlemint/network-bootstrapper"}` | Container image for the network bootstrapper job |
...
| network.network-bootstrapper.initContainer | object | `{"tcpCheck":{"image":{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}}}` | Init container configuration for dependency checking |
| network.network-bootstrapper.initContainer.tcpCheck | object | `{"image":{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}}` | TCP readiness check init container |
| network.network-bootstrapper.initContainer.tcpCheck.image | object | `{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}` | Wait-for-it utility image for TCP checks |
...
| network.network-nodes | object | `{"image":{"repository":"harbor.settlemint.com/docker.io/hyperledger/besu"},"initContainer":{"tcpCheck":{"image":{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}}},"persistence":{"size":"20Gi"}}` | Blockchain node configuration (validators and RPC) |
| network.network-nodes.image | object | `{"repository":"harbor.settlemint.com/docker.io/hyperledger/besu"}` | Hyperledger Besu container image |
...
| network.network-nodes.initContainer | object | `{"tcpCheck":{"image":{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}}}` | Init container for node startup dependencies |
| network.network-nodes.initContainer.tcpCheck | object | `{"image":{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}}` | TCP check before node starts |
| network.network-nodes.initContainer.tcpCheck.image | object | `{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}` | Wait-for-it utility image |
...
| observability | object | `{"alloy":{"alloy":{"resources":{}},"configReloader":{"image":{"registry":"harbor.settlemint.com/quay.io"}},"image":{"registry":"harbor.settlemint.com/docker.io"}},"enabled":true,"grafana":{"adminPassword":"atk","adminUser":"settlemint","image":{"registry":"harbor.settlemint.com/docker.io"},"ingress":{"hosts":["grafana.k8s.orb.local"]},"sidecar":{"image":{"registry":"harbor.settlemint.com/docker.io"}}},"kube-state-metrics":{"image":{"registry":"harbor.settlemint.com/registry.k8s.io"},"resources":{}},"loki":{"gateway":{"image":{"registry":"harbor.settlemint.com/docker.io"}},"loki":{"image":{"registry":"harbor.settlemint.com/docker.io"}},"memcached":{"enabled":true,"image":{"repository":"harbor.settlemint.com/docker.io/memcached"}},"memcachedExporter":{"image":{"repository":"harbor.settlemint.com/docker.io/prom/memcached-exporter"}},"sidecar":{"image":{"repository":"harbor.settlemint.com/docker.io/kiwigrid/k8s-sidecar"}},"singleBinary":{"extraEnv":[],"persistence":{"size":"10Gi"},"resources":{}}},"metrics-server":{"enabled":true,"image":{"repository":"harbor.settlemint.com/registry.k8s.io/metrics-server/metrics-server"},"resources":{}},"prometheus-node-exporter":{"image":{"registry":"harbor.settlemint.com/quay.io"}},"tempo":{"server":{"resources":{}},"tempo":{"repository":"harbor.settlemint.com/docker.io/grafana/tempo"},"tempoQuery":{"repository":"harbor.settlemint.com/docker.io/grafana/tempo-query"}},"victoria-metrics-single":{"server":{"image":{"registry":"harbor.settlemint.com/docker.io"},"persistentVolume":{"size":"10Gi","storageClass":""},"resources":{}}}}` | Observability stack (metrics, logging, tracing) |
| observability.alloy | object | `{"alloy":{"resources":{}},"configReloader":{"image":{"registry":"harbor.settlemint.com/quay.io"}},"image":{"registry":"harbor.settlemint.com/docker.io"}}` | Grafana Alloy for telemetry pipeline |
...
| observability.alloy.configReloader | object | `{"image":{"registry":"harbor.settlemint.com/quay.io"}}` | Config reloader sidecar |
| observability.alloy.configReloader.image | object | `{"registry":"harbor.settlemint.com/quay.io"}` | Config reloader image |
| observability.alloy.configReloader.image.registry | string | `"harbor.settlemint.com/quay.io"` | OCI registry for config reloader |
| observability.alloy.image | object | `{"registry":"harbor.settlemint.com/docker.io"}` | Alloy container image |
...
| observability.grafana | object | `{"adminPassword":"atk","adminUser":"settlemint","image":{"registry":"harbor.settlemint.com/docker.io"},"ingress":{"hosts":["grafana.k8s.orb.local"]},"sidecar":{"image":{"registry":"harbor.settlemint.com/docker.io"}}}` | Grafana visualization and dashboarding |
...
| observability.grafana.image | object | `{"registry":"harbor.settlemint.com/docker.io"}` | Grafana container image |
...
| observability.grafana.sidecar | object | `{"image":{"registry":"harbor.settlemint.com/docker.io"}}` | Sidecar for dashboard provisioning |
| observability.grafana.sidecar.image | object | `{"registry":"harbor.settlemint.com/docker.io"}` | Sidecar container image |
| observability.grafana.sidecar.image.registry | string | `"harbor.settlemint.com/docker.io"` | OCI registry for sidecar |
| observability.kube-state-metrics | object | `{"image":{"registry":"harbor.settlemint.com/registry.k8s.io"},"resources":{}}` | Kube State Metrics for cluster-level metrics |
| observability.kube-state-metrics.image | object | `{"registry":"harbor.settlemint.com/registry.k8s.io"}` | Kube state metrics container image |
...
| observability.loki | object | `{"gateway":{"image":{"registry":"harbor.settlemint.com/docker.io"}},"loki":{"image":{"registry":"harbor.settlemint.com/docker.io"}},"memcached":{"enabled":true,"image":{"repository":"harbor.settlemint.com/docker.io/memcached"}},"memcachedExporter":{"image":{"repository":"harbor.settlemint.com/docker.io/prom/memcached-exporter"}},"sidecar":{"image":{"repository":"harbor.settlemint.com/docker.io/kiwigrid/k8s-sidecar"}},"singleBinary":{"extraEnv":[],"persistence":{"size":"10Gi"},"resources":{}}}` | Loki log aggregation system |
| observability.loki.gateway | object | `{"image":{"registry":"harbor.settlemint.com/docker.io"}}` | Loki gateway for load balancing |
| observability.loki.gateway.image | object | `{"registry":"harbor.settlemint.com/docker.io"}` | Gateway container image |
| observability.loki.gateway.image.registry | string | `"harbor.settlemint.com/docker.io"` | OCI registry for gateway image |
| observability.loki.loki | object | `{"image":{"registry":"harbor.settlemint.com/docker.io"}}` | Loki server configuration |
| observability.loki.loki.image | object | `{"registry":"harbor.settlemint.com/docker.io"}` | Loki container image |
| observability.loki.loki.image.registry | string | `"harbor.settlemint.com/docker.io"` | OCI registry for Loki |
| observability.loki.memcached | object | `{"enabled":true,"image":{"repository":"harbor.settlemint.com/docker.io/memcached"}}` | Memcached for Loki query result caching |
| observability.loki.memcached.enabled | bool | `true` | Enable memcached deployment |
| observability.loki.memcached.image | object | `{"repository":"harbor.settlemint.com/docker.io/memcached"}` | Memcached container image |
...
| observability.loki.memcachedExporter | object | `{"image":{"repository":"harbor.settlemint.com/docker.io/prom/memcached-exporter"}}` | Memcached exporter for Prometheus metrics |
| observability.loki.memcachedExporter.image | object | `{"repository":"harbor.settlemint.com/docker.io/prom/memcached-exporter"}` | Memcached exporter image |
...
| observability.loki.sidecar | object | `{"image":{"repository":"harbor.settlemint.com/docker.io/kiwigrid/k8s-sidecar"}}` | Kubernetes sidecar for dynamic configuration |
| observability.loki.sidecar.image | object | `{"repository":"harbor.settlemint.com/docker.io/kiwigrid/k8s-sidecar"}` | Sidecar container image |
...
| observability.metrics-server | object | `{"enabled":true,"image":{"repository":"harbor.settlemint.com/registry.k8s.io/metrics-server/metrics-server"},"resources":{}}` | Kubernetes Metrics Server for resource metrics |
| observability.metrics-server.enabled | bool | `true` | Enable Metrics Server deployment |
| observability.metrics-server.image | object | `{"repository":"harbor.settlemint.com/registry.k8s.io/metrics-server/metrics-server"}` | Metrics Server container image |
...
| observability.prometheus-node-exporter | object | `{"image":{"registry":"harbor.settlemint.com/quay.io"}}` | Prometheus Node Exporter for host metrics |
| observability.prometheus-node-exporter.image | object | `{"registry":"harbor.settlemint.com/quay.io"}` | Node exporter container image |
...
| observability.tempo | object | `{"server":{"resources":{}},"tempo":{"repository":"harbor.settlemint.com/docker.io/grafana/tempo"},"tempoQuery":{"repository":"harbor.settlemint.com/docker.io/grafana/tempo-query"}}` | Tempo distributed tracing backend |
...
| observability.tempo.tempo | object | `{"repository":"harbor.settlemint.com/docker.io/grafana/tempo"}` | Tempo server image configuration |
| observability.tempo.tempo.repository | string | `"harbor.settlemint.com/docker.io/grafana/tempo"` | Tempo image repository |
| observability.tempo.tempoQuery | object | `{"repository":"harbor.settlemint.com/docker.io/grafana/tempo-query"}` | Tempo query frontend image |
...
| observability.victoria-metrics-single | object | `{"server":{"image":{"registry":"harbor.settlemint.com/docker.io"},"persistentVolume":{"size":"10Gi","storageClass":""},"resources":{}}}` | VictoriaMetrics time-series database for metrics storage |
| observability.victoria-metrics-single.server | object | `{"image":{"registry":"harbor.settlemint.com/docker.io"},"persistentVolume":{"size":"10Gi","storageClass":""},"resources":{}}` | VictoriaMetrics server configuration |
| observability.victoria-metrics-single.server.image | object | `{"registry":"harbor.settlemint.com/docker.io"}` | VictoriaMetrics container image |
...
| portal | object | `{"enabled":true,"image":{"registry":"harbor.settlemint.com/ghcr.io"},"ingress":{"hostname":"portal.k8s.orb.local"},"initContainer":{"tcpCheck":{"image":{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}}}}` | Portal identity and access management configuration |
| portal.enabled | bool | `true` | Enable deployment of Portal IAM service |
| portal.image | object | `{"registry":"harbor.settlemint.com/ghcr.io"}` | Portal container image |
...
| portal.initContainer | object | `{"tcpCheck":{"image":{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}}}` | Init container for dependency checks |
| portal.initContainer.tcpCheck | object | `{"image":{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}}` | TCP check for database readiness |
| portal.initContainer.tcpCheck.image | object | `{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}` | Wait-for-it utility image |
...
| support | object | `{"enabled":true,"ingress-nginx":{"controller":{"image":{"repository":"harbor.settlemint.com/registry.k8s.io/ingress-nginx/controller"},"resources":{}},"enabled":true,"replicaCount":1},"minio":{"enabled":true,"image":{"repository":"harbor.settlemint.com/docker.io/minio/minio"},"ingress":{"enabled":true,"hosts":["minio.k8s.orb.local"],"ingressClassName":"atk-nginx","path":"/"},"mcImage":{"repository":"harbor.settlemint.com/docker.io/minio/minio"}},"postgresql":{"enabled":true,"image":{"registry":"harbor.settlemint.com/docker.io"}},"redis":{"auth":{"enabled":true,"password":"atk"},"commonLabels":{"app.kubernetes.io/managed-by":"helm","kots.io/app-slug":"settlemint-atk"},"enabled":true,"fullnameOverride":"redis","image":{"registry":"harbor.settlemint.com/docker.io"},"persistence":{"enabled":true,"size":"1Gi"},"resources":{"limits":{"cpu":"200m","memory":"256Mi"},"requests":{"cpu":"100m","memory":"128Mi"}}},"reloader":{"enabled":true,"image":{"repository":"harbor.settlemint.com/ghcr.io/stakater/reloader"}}}` | Support infrastructure (ingress, reloader, databases, object storage) |
| support.enabled | bool | `true` | Enable deployment of support infrastructure components |
| support.ingress-nginx | object | `{"controller":{"image":{"repository":"harbor.settlemint.com/registry.k8s.io/ingress-nginx/controller"},"resources":{}},"enabled":true,"replicaCount":1}` | NGINX Ingress Controller configuration |
| support.ingress-nginx.controller | object | `{"image":{"repository":"harbor.settlemint.com/registry.k8s.io/ingress-nginx/controller"},"resources":{}}` | Ingress controller configuration |
| support.ingress-nginx.controller.image | object | `{"repository":"harbor.settlemint.com/registry.k8s.io/ingress-nginx/controller"}` | Ingress controller container image |
...
| support.minio | object | `{"enabled":true,"image":{"repository":"harbor.settlemint.com/docker.io/minio/minio"},"ingress":{"enabled":true,"hosts":["minio.k8s.orb.local"],"ingressClassName":"atk-nginx","path":"/"},"mcImage":{"repository":"harbor.settlemint.com/docker.io/minio/minio"}}` | MinIO object storage configuration |
| support.minio.enabled | bool | `true` | Enable MinIO object storage deployment |
| support.minio.image | object | `{"repository":"harbor.settlemint.com/docker.io/minio/minio"}` | MinIO server container image |
...
| support.minio.mcImage | object | `{"repository":"harbor.settlemint.com/docker.io/minio/minio"}` | MinIO client (mc) container image |
| support.minio.mcImage.repository | string | `"harbor.settlemint.com/docker.io/minio/minio"` | MinIO client image repository |
| support.postgresql | object | `{"enabled":true,"image":{"registry":"harbor.settlemint.com/docker.io"}}` | PostgreSQL database configuration |
| support.postgresql.enabled | bool | `true` | Enable PostgreSQL deployment |
| support.postgresql.image | object | `{"registry":"harbor.settlemint.com/docker.io"}` | PostgreSQL container image |
...
| support.redis.image | object | `{"registry":"harbor.settlemint.com/docker.io"}` | Redis container image |
...
| support.reloader | object | `{"enabled":true,"image":{"repository":"harbor.settlemint.com/ghcr.io/stakater/reloader"}}` | Stakater Reloader for automatic pod restarts on config changes |
| support.reloader.enabled | bool | `true` | Enable Reloader deployment |
| support.reloader.image | object | `{"repository":"harbor.settlemint.com/ghcr.io/stakater/reloader"}` | Reloader container image |
| support.reloader.image.repository | string | `"harbor.settlemint.com/ghcr.io/stakater/reloader"` | Reloader image repository |
| txsigner | object | `{"config":{"derivationPath":"m/44'/60'/0'/0/0","mnemonic":"gate yellow grunt wrestle disease obtain mixed nature mansion tape purchase awful"},"enabled":true,"image":{"registry":"harbor.settlemint.com/ghcr.io"},"ingress":{"enabled":false,"hostname":"txsigner.k8s.orb.local"},"initContainer":{"tcpCheck":{"image":{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}}},"resources":{},"tests":{"image":{"registry":"harbor.settlemint.com/docker.io"}}}` | Transaction Signer service configuration |
...
| txsigner.image | object | `{"registry":"harbor.settlemint.com/ghcr.io"}` | Transaction signer container image |
...
| txsigner.initContainer | object | `{"tcpCheck":{"image":{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}}}` | Init container for dependency checks |
| txsigner.initContainer.tcpCheck | object | `{"image":{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}}` | TCP check for blockchain node readiness |
| txsigner.initContainer.tcpCheck.image | object | `{"repository":"harbor.settlemint.com/ghcr.io/settlemint/btp-waitforit"}` | Wait-for-it utility image |
...
| txsigner.tests | object | `{"image":{"registry":"harbor.settlemint.com/docker.io"}}` | Test container image for health checks |
| txsigner.tests.image | object | `{"registry":"harbor.settlemint.com/docker.io"}` | Test image configuration |
