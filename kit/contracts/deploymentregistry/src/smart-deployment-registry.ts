...
export function handleRoleAdminChanged(event: RoleAdminChanged): void {
  ...
  // - contract.DEPLOYMENT_OWNER_ROLE(...)
  // - contract.areDependenciesRegistered(...)
  // - contract.complianceModules(...)
  // - contract.deploymentRegistrar(...)
  // - contract.getRegisteredComplianceModules(...)
  // - contract.getRoleAdmin(...)
  // - contract.getTokenRegistryByType(...)
  // - contract.hasRole(...)
  // - contract.isAdmin(...)
  // - contract.isComplianceModuleRegistered(...)
  // - contract.isDeploymentOwner(...)
  // - contract.isTokenRegistryAddressUsed(...)
  // - contract.isTrustedForwarder(...)
  // - contract.registrationTimestamp(...)
  // - contract.smartComplianceContract(...)
  // - contract.smartIdentityFactoryContract(...)
  // - contract.smartIdentityRegistryContract(...)
  // - contract.smartIdentityRegistryStorageContract(...)
  // - contract.smartTrustedIssuersRegistryContract(...)
  // - contract.supportsInterface(...)
  // - contract.tokenRegistriesByType(...)
