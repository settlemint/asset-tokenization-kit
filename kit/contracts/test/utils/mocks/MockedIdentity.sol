...
contract MockedIdentity is IIdentity {
	...
	function addKey(bytes32 /* _key */, uint256 /* _purpose */, uint256 /* _keyType */) external pure override returns (bool /* success */) {
		revert Unimplemented();
	}
	...
	function execute(address /* _to */, uint256 /* _value */, bytes calldata /* _data */) external payable override returns (uint256 /* executionId */) {
		revert Unimplemented();
	}
	...
	function keyHasPurpose(bytes32 /* _key */, uint256 /* _purpose */) external pure override returns (bool /* exists */) {
		revert Unimplemented();
	}
