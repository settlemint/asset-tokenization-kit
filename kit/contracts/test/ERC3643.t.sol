...
/**
 *     The SMART protocol is a suite of smart contracts implementing the ERC-3643
 *     standard, the T-REX standard implementation and extended and reworked by
 *     SettleMint to manage and transfer a wide variety of financial assets on EVM
 *     blockchains.
 *
 *     Copyright (C) 2025, SettleMint NV
 *
