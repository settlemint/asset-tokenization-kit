...
const ABI_PATHS = {
  ...
  systemTrustedIssuersRegistry: `${ARTIFACTS_DIR}/contracts/system/trusted-issuers-registry/IATKSystemTrustedIssuersRegistry.sol/IATKSystemTrustedIssuersRegistry.json`,
  trustedIssuersMetaRegistry: `${ARTIFACTS_DIR}/contracts/system/trusted-issuers-registry/IATKTrustedIssuersMetaRegistry.sol/IATKTrustedIssuersMetaRegistry.json`,
  tokenTrustedIssuersRegistry: `${ARTIFACTS_DIR}/contracts/system/tokens/trusted-issuers-registry/IATKTokenTrustedIssuersRegistry.sol/IATKTokenTrustedIssuersRegistry.json`,
