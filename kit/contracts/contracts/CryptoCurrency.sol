...
/// @notice This contract provides a standard ERC20 token with minting capabilities controlled by an owner
/// @dev Inherits from OpenZeppelin's ERC20, Ownable and ERC20Permit contracts
/// @custom:security-contact support@settlemint.com
contract CryptoCurrency is ERC20, Ownable, ERC20Permit {
    ...
    /// @param initialOwner The address that will receive ownership and initial supply
    constructor(
        string memory name,
    ...
    /// @dev Only callable by the contract owner. Amount is in base units
