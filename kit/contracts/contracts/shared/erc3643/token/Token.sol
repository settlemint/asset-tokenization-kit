...
import { TokenPermit } from "./TokenPermit.sol";
...
import {
    ...
    ERC20InvalidSender
} from "../errors/CommonErrors.sol";
import { ZeroAddress, EmptyString, DecimalsOutOfRange } from "../errors/InvalidArgumentErrors.sol";
import { AgentRestrictionsSet, DefaultAllowance, DefaultAllowanceDisabled, DefaultAllowanceEnabled } from "./IToken.sol";
