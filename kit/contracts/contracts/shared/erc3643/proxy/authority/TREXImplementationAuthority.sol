...
import {
    ...
    TREXVersionAdded,
    VersionUpdated
} from "./ITREXImplementationAuthority.sol";
...
/// @dev Thrown when version of new implementation authority is not the same as the current implementation authority
/// version.
error VersionOfNewIAMustBeTheSameAsCurrentIA();

/// @dev Thrown when implementation authority is invalid.
...
contract TREXImplementationAuthority is ITREXImplementationAuthority, Ownable, IERC165 {
     ...
     */
    constructor(bool referenceStatus, address trexFactory, address iaFactory) Ownable(_msgSender()) {
