...
import { ITREXFactory, TREXSuiteDeployed, IdFactorySet, Deployed } from "./ITREXFactory.sol";
...
contract TREXFactory is ITREXFactory, Ownable {
    ...
    constructor(address implementationAuthority_, address idFactory_) Ownable(_msgSender()) {
