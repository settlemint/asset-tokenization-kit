...
interface IERC3643 is IERC20, IERC20Metadata {
     ...
     *  To execute this function, the calling agent must not be restricted from initiating forced transfers of the
     * token.
     ...
     *
     * Reverts if:
     * - The agent calling the function does not have the necessary permissions to perform recovery
     * (`AgentNotAuthorized`).
