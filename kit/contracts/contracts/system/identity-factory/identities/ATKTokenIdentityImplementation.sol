...
contract ATKTokenIdentityImplementation is
    IATKTokenIdentity,
    ERC165Upgradeable,
    ...
    ISMARTTokenAccessManaged
{
    ...
    function addClaim(
        ...
        onlyAccessManagerRole(ATKSystemRoles.CLAIM_MANAGER_ROLE)
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC165Upgradeable) returns (bool) {
        return interfaceId == type(IATKTokenIdentity).interfaceId || interfaceId == type(IERC735).interfaceId
