...
declare module "@nomicfoundation/hardhat-viem/types" {
  export function deployContract(
    contractName: "ATKIdentityRegistryProxy",
    constructorArgs: [systemAddress: AbiParameterToPrimitiveType<{"name":"systemAddress","type":"address"}>, initialAdmin: AbiParameterToPrimitiveType<{"name":"initialAdmin","type":"address"}>, identityStorage: AbiParameterToPrimitiveType<{"name":"identityStorage","type":"address"}>, trustedIssuersRegistry: AbiParameterToPrimitiveType<{"name":"trustedIssuersRegistry","type":"address"}>, topicSchemeRegistry: AbiParameterToPrimitiveType<{"name":"topicSchemeRegistry","type":"address"}>],
