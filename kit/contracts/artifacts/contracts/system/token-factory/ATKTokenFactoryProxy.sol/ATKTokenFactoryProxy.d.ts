...
declare module "@nomicfoundation/hardhat-viem/types" {
  export function deployContract(
    contractName: "ATKTokenFactoryProxy",
    constructorArgs: [systemAddress: AbiParameterToPrimitiveType<{"name":"systemAddress","type":"address"}>, initialAdmin: AbiParameterToPrimitiveType<{"name":"initialAdmin","type":"address"}>, factoryTypeHash: AbiParameterToPrimitiveType<{"name":"factoryTypeHash","type":"bytes32"}>, tokenImplementation: AbiParameterToPrimitiveType<{"name":"tokenImplementation","type":"address"}>, identityVerificationModule: AbiParameterToPrimitiveType<{"name":"identityVerificationModule","type":"address"}>],
