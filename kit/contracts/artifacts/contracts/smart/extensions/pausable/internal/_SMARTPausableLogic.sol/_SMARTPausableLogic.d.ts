...
export interface _SMARTPausableLogic$Type {
  ...
  sourceName: "contracts/smart/extensions/pausable/internal/_SMARTPausableLogic.sol";
  abi: [
    {
      inputs: [];
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  export function deployContract(
    contractName: "contracts/smart/extensions/pausable/internal/_SMARTPausableLogic.sol:_SMARTPausableLogic",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<_SMARTPausableLogic$Type["abi"]>>;
