...
export interface _SMARTRedeemableLogic$Type {
  ...
  sourceName: "contracts/smart/extensions/redeemable/internal/_SMARTRedeemableLogic.sol";
  abi: [
    {
      inputs: [];
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  export function deployContract(
    contractName: "contracts/smart/extensions/redeemable/internal/_SMARTRedeemableLogic.sol:_SMARTRedeemableLogic",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<_SMARTRedeemableLogic$Type["abi"]>>;
