...
export interface SMARTRedeemable$Type {
  ...
  "sourceName": "contracts/smart/extensions/redeemable/SMARTRedeemable.sol",
  "abi": [
    {
      "inputs": [],
...
declare module "@nomicfoundation/hardhat-viem/types" {
  export function deployContract(
    contractName: "contracts/smart/extensions/redeemable/SMARTRedeemable.sol:SMARTRedeemable",
    constructorArgs?: [],
