...
export interface SMARTCapped$Type {
  _format: "hh-sol-artifact-1";
  contractName: "SMARTCapped";
  sourceName: "contracts/smart/extensions/capped/SMARTCapped.sol";
  abi: [
    {
      inputs: [];
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  ): Promise<GetContractReturnType<SMARTCapped$Type["abi"]>>;
  export function deployContract(
    contractName: "contracts/smart/extensions/capped/SMARTCapped.sol:SMARTCapped",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<SMARTCapped$Type["abi"]>>;
  ...
  export function sendDeploymentTransaction(
    ...
    contract: GetContractReturnType<SMARTCapped$Type["abi"]>;
