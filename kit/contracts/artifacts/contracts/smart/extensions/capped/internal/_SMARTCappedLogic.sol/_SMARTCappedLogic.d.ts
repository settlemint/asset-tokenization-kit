...
export interface _SMARTCappedLogic$Type {
  _format: "hh-sol-artifact-1";
  contractName: "_SMARTCappedLogic";
  sourceName: "contracts/smart/extensions/capped/internal/_SMARTCappedLogic.sol";
  abi: [
    {
      inputs: [];
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  ): Promise<GetContractReturnType<_SMARTCappedLogic$Type["abi"]>>;
  export function deployContract(
    contractName: "contracts/smart/extensions/capped/internal/_SMARTCappedLogic.sol:_SMARTCappedLogic",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<_SMARTCappedLogic$Type["abi"]>>;
  ...
  export function sendDeploymentTransaction(
    ...
    contract: GetContractReturnType<_SMARTCappedLogic$Type["abi"]>;
