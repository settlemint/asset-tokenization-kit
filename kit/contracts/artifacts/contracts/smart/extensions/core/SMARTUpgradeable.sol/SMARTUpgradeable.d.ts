...
export interface SMARTUpgradeable$Type {
  _format: "hh-sol-artifact-1";
  contractName: "SMARTUpgradeable";
  sourceName: "contracts/smart/extensions/core/SMARTUpgradeable.sol";
  abi: [
    {
      inputs: [];
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  ): Promise<GetContractReturnType<SMARTUpgradeable$Type["abi"]>>;
  export function deployContract(
    contractName: "contracts/smart/extensions/core/SMARTUpgradeable.sol:SMARTUpgradeable",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<SMARTUpgradeable$Type["abi"]>>;
  ...
  export function sendDeploymentTransaction(
    ...
    contract: GetContractReturnType<SMARTUpgradeable$Type["abi"]>;
