...
export interface SMARTTokenAccessManaged$Type {
  _format: "hh-sol-artifact-1";
  contractName: "SMARTTokenAccessManaged";
  sourceName: "contracts/smart/extensions/access-managed/SMARTTokenAccessManaged.sol";
  abi: [
    {
      inputs: [
        {
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  ): Promise<GetContractReturnType<SMARTTokenAccessManaged$Type["abi"]>>;
  export function deployContract(
    contractName: "contracts/smart/extensions/access-managed/SMARTTokenAccessManaged.sol:SMARTTokenAccessManaged",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<SMARTTokenAccessManaged$Type["abi"]>>;
  ...
  export function sendDeploymentTransaction(
    ...
    contract: GetContractReturnType<SMARTTokenAccessManaged$Type["abi"]>;
