...
export interface SMARTCustodianUpgradeable$Type {
  _format: "hh-sol-artifact-1";
  contractName: "SMARTCustodianUpgradeable";
  sourceName: "contracts/smart/extensions/custodian/SMARTCustodianUpgradeable.sol";
  abi: [
    {
      inputs: [];
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  ): Promise<GetContractReturnType<SMARTCustodianUpgradeable$Type["abi"]>>;
  export function deployContract(
    contractName: "contracts/smart/extensions/custodian/SMARTCustodianUpgradeable.sol:SMARTCustodianUpgradeable",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<SMARTCustodianUpgradeable$Type["abi"]>>;
  ...
  export function sendDeploymentTransaction(
    ...
    contract: GetContractReturnType<SMARTCustodianUpgradeable$Type["abi"]>;
