...
export interface SMARTYield$Type {
  "_format": "hh-sol-artifact-1",
  "contractName": "SMARTYield",
  "sourceName": "contracts/smart/extensions/yield/SMARTYield.sol",
  "abi": [
    {
      "inputs": [],
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  ): Promise<GetContractReturnType<SMARTYield$Type["abi"]>>;
  export function deployContract(
    contractName: "contracts/smart/extensions/yield/SMARTYield.sol:SMARTYield",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<SMARTYield$Type["abi"]>>;
  ...
  export function sendDeploymentTransaction(
    ...
    contract: GetContractReturnType<SMARTYield$Type["abi"]>;
