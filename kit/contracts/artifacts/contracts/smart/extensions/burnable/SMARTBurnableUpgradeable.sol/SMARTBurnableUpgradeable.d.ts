...
export interface SMARTBurnableUpgradeable$Type {
  _format: "hh-sol-artifact-1";
  contractName: "SMARTBurnableUpgradeable";
  sourceName: "contracts/smart/extensions/burnable/SMARTBurnableUpgradeable.sol";
  abi: [
    {
      inputs: [];
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  ): Promise<GetContractReturnType<SMARTBurnableUpgradeable$Type["abi"]>>;
  export function deployContract(
    contractName: "contracts/smart/extensions/burnable/SMARTBurnableUpgradeable.sol:SMARTBurnableUpgradeable",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<SMARTBurnableUpgradeable$Type["abi"]>>;
  ...
  export function sendDeploymentTransaction(
    ...
    contract: GetContractReturnType<SMARTBurnableUpgradeable$Type["abi"]>;
