...
export interface _SMARTBurnableLogic$Type {
  ...
  sourceName: "contracts/smart/extensions/burnable/internal/_SMARTBurnableLogic.sol";
  abi: [
    {
      inputs: [];
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  export function deployContract(
    contractName: "contracts/smart/extensions/burnable/internal/_SMARTBurnableLogic.sol:_SMARTBurnableLogic",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<_SMARTBurnableLogic$Type["abi"]>>;
