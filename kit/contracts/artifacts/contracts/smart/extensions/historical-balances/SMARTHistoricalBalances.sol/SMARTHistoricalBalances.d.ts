...
export interface SMARTHistoricalBalances$Type {
  ...
  "sourceName": "contracts/smart/extensions/historical-balances/SMARTHistoricalBalances.sol",
  "abi": [
    {
      "inputs": [],
...
declare module "@nomicfoundation/hardhat-viem/types" {
  export function deployContract(
    contractName: "contracts/smart/extensions/historical-balances/SMARTHistoricalBalances.sol:SMARTHistoricalBalances",
    constructorArgs?: [],
