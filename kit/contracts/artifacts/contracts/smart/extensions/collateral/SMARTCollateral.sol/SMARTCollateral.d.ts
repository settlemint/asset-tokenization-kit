...
export interface SMARTCollateral$Type {
  ...
  "sourceName": "contracts/smart/extensions/collateral/SMARTCollateral.sol",
  "abi": [
    {
      "inputs": [],
...
declare module "@nomicfoundation/hardhat-viem/types" {
  export function deployContract(
    contractName: "contracts/smart/extensions/collateral/SMARTCollateral.sol:SMARTCollateral",
    constructorArgs?: [],
