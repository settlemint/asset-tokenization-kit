...
export interface _SMARTCollateralLogic$Type {
  ...
  sourceName: "contracts/smart/extensions/collateral/internal/_SMARTCollateralLogic.sol";
  abi: [
    {
      inputs: [];
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  export function deployContract(
    contractName: "contracts/smart/extensions/collateral/internal/_SMARTCollateralLogic.sol:_SMARTCollateralLogic",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<_SMARTCollateralLogic$Type["abi"]>>;
