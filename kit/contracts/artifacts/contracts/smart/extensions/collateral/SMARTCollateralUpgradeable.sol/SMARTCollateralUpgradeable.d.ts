...
export interface SMARTCollateralUpgradeable$Type {
  _format: "hh-sol-artifact-1";
  contractName: "SMARTCollateralUpgradeable";
  sourceName: "contracts/smart/extensions/collateral/SMARTCollateralUpgradeable.sol";
  abi: [
    {
      inputs: [];
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  ): Promise<GetContractReturnType<SMARTCollateralUpgradeable$Type["abi"]>>;
  export function deployContract(
    contractName: "contracts/smart/extensions/collateral/SMARTCollateralUpgradeable.sol:SMARTCollateralUpgradeable",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<SMARTCollateralUpgradeable$Type["abi"]>>;
  ...
  export function sendDeploymentTransaction(
    ...
    contract: GetContractReturnType<SMARTCollateralUpgradeable$Type["abi"]>;
