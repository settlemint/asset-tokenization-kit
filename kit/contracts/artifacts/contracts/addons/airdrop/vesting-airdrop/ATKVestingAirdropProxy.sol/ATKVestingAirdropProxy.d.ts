...
declare module "@nomicfoundation/hardhat-viem/types" {
  export function deployContract(
    ...
    constructorArgs: [
      ...
      token: AbiParameterToPrimitiveType<{ name: "token"; type: "address" }>,
      root: AbiParameterToPrimitiveType<{ name: "root"; type: "bytes32" }>,
      owner: AbiParameterToPrimitiveType<{ name: "owner"; type: "address" }>,
      vestingStrategy: AbiParameterToPrimitiveType<{
        name: "vestingStrategy";
        type: "address";
      }>,
      initializationDeadline: AbiParameterToPrimitiveType<{
        name: "initializationDeadline";
        type: "uint256";
      }>,
    ],
