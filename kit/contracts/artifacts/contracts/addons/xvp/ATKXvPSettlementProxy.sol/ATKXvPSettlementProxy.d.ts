...
declare module "@nomicfoundation/hardhat-viem/types" {
  export function deployContract(
    contractName: "ATKXvPSettlementProxy",
    constructorArgs: [factoryAddress: AbiParameterToPrimitiveType<{"name":"factoryAddress","type":"address"}>, cutoffDate: AbiParameterToPrimitiveType<{"name":"cutoffDate","type":"uint256"}>, autoExecute: AbiParameterToPrimitiveType<{"name":"autoExecute","type":"bool"}>, flows: AbiParameterToPrimitiveType<{"name":"flows","type":"tuple[]"}>],
