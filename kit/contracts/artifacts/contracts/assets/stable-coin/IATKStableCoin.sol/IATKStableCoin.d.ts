...
export interface IATKStableCoin$Type {
  _format: "hh-sol-artifact-1";
  contractName: "IATKStableCoin";
  sourceName: "contracts/assets/stable-coin/IATKStableCoin.sol";
  abi: [
    {
      inputs: [
        {
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  ): Promise<GetContractReturnType<IATKStableCoin$Type["abi"]>>;
  export function deployContract(
    contractName: "contracts/assets/stable-coin/IATKStableCoin.sol:IATKStableCoin",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<IATKStableCoin$Type["abi"]>>;
  ...
  export function sendDeploymentTransaction(
    ...
    contract: GetContractReturnType<IATKStableCoin$Type["abi"]>;
