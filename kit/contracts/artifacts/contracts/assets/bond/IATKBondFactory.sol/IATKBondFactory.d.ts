...
export interface IATKBondFactory$Type {
  "_format": "hh-sol-artifact-1",
  "contractName": "IATKBondFactory",
  "sourceName": "contracts/assets/bond/IATKBondFactory.sol",
  "abi": [
    {
      "inputs": [
        {
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  ): Promise<GetContractReturnType<IATKBondFactory$Type["abi"]>>;
  export function deployContract(
    contractName: "contracts/assets/bond/IATKBondFactory.sol:IATKBondFactory",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<IATKBondFactory$Type["abi"]>>;
  ...
  export function sendDeploymentTransaction(
    ...
    contract: GetContractReturnType<IATKBondFactory$Type["abi"]>;
