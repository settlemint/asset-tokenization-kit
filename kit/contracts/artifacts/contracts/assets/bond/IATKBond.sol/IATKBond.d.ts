...
export interface IATKBond$Type {
  "_format": "hh-sol-artifact-1",
  "contractName": "IATKBond",
  "sourceName": "contracts/assets/bond/IATKBond.sol",
  "abi": [
    {
      "inputs": [
        {
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  ): Promise<GetContractReturnType<IATKBond$Type["abi"]>>;
  export function deployContract(
    contractName: "contracts/assets/bond/IATKBond.sol:IATKBond",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<IATKBond$Type["abi"]>>;
  ...
  export function sendDeploymentTransaction(
    ...
    contract: GetContractReturnType<IATKBond$Type["abi"]>;
