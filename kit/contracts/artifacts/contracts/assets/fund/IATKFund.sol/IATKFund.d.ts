...
export interface IATKFund$Type {
  _format: "hh-sol-artifact-1";
  contractName: "IATKFund";
  sourceName: "contracts/assets/fund/IATKFund.sol";
  abi: [
    {
      inputs: [
        {
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  ): Promise<GetContractReturnType<IATKFund$Type["abi"]>>;
  export function deployContract(
    contractName: "contracts/assets/fund/IATKFund.sol:IATKFund",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<IATKFund$Type["abi"]>>;
  ...
  export function sendDeploymentTransaction(
    ...
    contract: GetContractReturnType<IATKFund$Type["abi"]>;
