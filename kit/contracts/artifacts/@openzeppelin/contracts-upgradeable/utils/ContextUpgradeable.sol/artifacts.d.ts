...
declare module "hardhat/types/artifacts" {
  ...
  interface ContractTypesMap {
    ["ContextUpgradeable"]: GetContractReturnType<
      ContextUpgradeable$Type["abi"]
    >;
    ["@openzeppelin/contracts-upgradeable/utils/ContextUpgradeable.sol:ContextUpgradeable"]: GetContractReturnType<
      ContextUpgradeable$Type["abi"]
    >;
  }
}
