...
export interface _SMARTHistoricalBalancesLogic$Type {
  ...
  "sourceName": "smart-protocol/contracts/extensions/historical-balances/internal/_SMARTHistoricalBalancesLogic.sol",
  "abi": [
    {
      "inputs": [
        {
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  export function deployContract(
    contractName: "smart-protocol/contracts/extensions/historical-balances/internal/_SMARTHistoricalBalancesLogic.sol:_SMARTHistoricalBalancesLogic",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<_SMARTHistoricalBalancesLogic$Type["abi"]>>;
