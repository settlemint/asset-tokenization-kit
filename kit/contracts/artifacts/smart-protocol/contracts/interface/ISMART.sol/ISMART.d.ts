...
export interface ISMART$Type {
  "_format": "hh-sol-artifact-1",
  "contractName": "ISMART",
  "sourceName": "smart-protocol/contracts/interface/ISMART.sol",
  "abi": [
    {
      "inputs": [],
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  ): Promise<GetContractReturnType<ISMART$Type["abi"]>>;
  export function deployContract(
    contractName: "smart-protocol/contracts/interface/ISMART.sol:ISMART",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<ISMART$Type["abi"]>>;
  ...
  export function sendDeploymentTransaction(
    ...
    contract: GetContractReturnType<ISMART$Type["abi"]>;
