...
export interface ISMARTComplianceModule$Type {
  ...
  "sourceName": "smart-protocol/contracts/interface/ISMARTComplianceModule.sol",
  "abi": [
    {
      "inputs": [
        {
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  export function deployContract(
    contractName: "smart-protocol/contracts/interface/ISMARTComplianceModule.sol:ISMARTComplianceModule",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<ISMARTComplianceModule$Type["abi"]>>;
