...
export const tokenFixedYieldSchedule = () =>
  z.object({
    ...
    periods: z
      .array(tokenFixedYieldSchedulePeriod())
 ...
 */
export type TokenFixedYieldSchedulePeriod = z.infer<
  ReturnType<typeof tokenFixedYieldSchedulePeriod>
>;
 ...
 * Ensures type safety and proper data structure.
 */
export type TokenFixedYieldSchedule = z.infer<
  ReturnType<typeof tokenFixedYieldSchedule>
>;
