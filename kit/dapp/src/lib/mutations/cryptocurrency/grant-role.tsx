...
/**
 * Function to grant roles to a user for a cryptocurrency
 *
...
/**
 * React Query hook for granting roles to a user for a cryptocurrency
 *
...
export function useGrantRole() {
  const mutation = useMutation({
    mutationKey: ['cryptocurrency', 'grant-role'],
    mutationFn: async ({
      pincode,
      from,
      address,
