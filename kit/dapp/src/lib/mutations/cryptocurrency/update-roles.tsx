import { revokeRole } from '@/lib/mutations/cryptocurrency/revoke-role';
...
/**
 * React Query hook for updating a user's roles for a cryptocurrency
 *
...
export function useUpdateRoles() {
  const mutation = useMutation({
    mutationKey: ['cryptocurrency', 'update-roles'],
    mutationFn: async ({
      pincode,
      from,
      address,
