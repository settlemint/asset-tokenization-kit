...
export function useLanguageDetection() {
  ...
  useEffect(() => {
    ...
    if (storedLang && supportedLanguages.includes(storedLang as typeof supportedLanguages[number])) {
    ...
    const detectedLang =
      browserLang && supportedLanguages.includes(browserLang as typeof supportedLanguages[number])
        ? browserLang
        : fallbackLng;
