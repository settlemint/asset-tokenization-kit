import { completeOnboarding } from "@/orpc/routes/user/routes/user.completeOnboarding";
 ...
 * - completeOnboarding: POST /user/complete-onboarding - Mark onboarding as complete
 *
 ...
 * @see {@link ./routes/user.completeOnboarding} - Onboarding completion endpoint
 */
const routes = {
  me,
  list,
