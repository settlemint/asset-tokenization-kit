...
} from "@/orpc/routes/token/routes/stats/[assetId]/total-supply.schema";

export const tokenStatsAssetTotalSupplyContract = baseContract
  .route({
    method: "GET",
    path: "/token/stats/{assetId}/total-supply",
    description: "Get total supply history statistics for a specific asset",
    successDescription: "Asset total supply history statistics",
