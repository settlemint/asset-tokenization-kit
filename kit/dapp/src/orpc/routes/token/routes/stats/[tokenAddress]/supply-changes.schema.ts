 ...
 */
export const TokenStatsAssetSupplyChangesInputSchema = z.object({
 ...
 */
export const TokenStatsAssetSupplyChangesOutputSchema = z.object({
 ...
 */
export type TokenStatsAssetSupplyChangesInput = z.infer<
  typeof TokenStatsAssetSupplyChangesInputSchema
>;

/**
 * Type definition for asset-specific supply changes output
 */
export type TokenStatsAssetSupplyChangesOutput = z.infer<
  typeof TokenStatsAssetSupplyChangesOutputSchema
>;
