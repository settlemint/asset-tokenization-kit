 ...
 */
export type BaseFormInputProps<T extends FieldValues> = UseControllerProps<T> & {
 ...
 */
export function getAriaAttributes(name: string, hasError: boolean, disabled?: boolean) {
  return {
