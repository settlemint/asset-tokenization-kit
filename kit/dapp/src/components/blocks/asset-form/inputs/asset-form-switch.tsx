...
import type { BaseFormInputProps, WithHelperTextProps } from '@/types/form-types';
...
type AssetFormSwitchProps<T extends FieldValues> = Omit<SwitchProps, keyof BaseFormInputProps<T>> &
