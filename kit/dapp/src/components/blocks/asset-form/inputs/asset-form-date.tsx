...
type AssetFormDateProps<T extends FieldValues> = Omit<CalendarProps, keyof BaseFormInputProps<T>> &
            ...
            <FormControl>
              <Popover>
                <PopoverTrigger asChild>
                  ...
                  >
                    {field.value ? (
                      <time dateTime={field.value.toISOString()}>{format(field.value, 'PPP')}</time>
                    ) : (
