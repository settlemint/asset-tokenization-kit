...
type FormOtp<T extends FieldValues> = Omit<InputProps, keyof BaseFormInputProps<T> | 'maxLength' | 'pattern'> &
  BaseFormInputProps<T>;

export function FormOtp<T extends FieldValues>({ label, rules, description, className, ...props }: FormOtp<T>) {
