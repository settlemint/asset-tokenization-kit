...
Below is a mermaid diagram outlining the lifecycle of a tokenized fund on the
blockchain:
...
This diagram illustrates how a fund is deployed and managed on the blockchain,
enabling transparency, automation, and broader access for investors.
