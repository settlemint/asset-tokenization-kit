...
import { stableCoinUpdatePermissionsAction } from "@/lib/mutations/asset/access-control/update-role/update-roles-action";
            ...
            actions={[
              {
                ...
                component: ({ open, onOpenChange }) => (
                  <EditPermissionsForm
                    ...
                    updateRolesAction={stableCoinUpdatePermissionsAction}
              ...
              },
              {
                ...
                component: ({ open, onOpenChange }) => (
                  <RevokeAllPermissionsForm
                    ...
                    open={open}
                    onOpenChange={onOpenChange}
                    revokeRoleAction={stablecoinRevokeRoleAction}
                  />
                ),
              },
            ]}
