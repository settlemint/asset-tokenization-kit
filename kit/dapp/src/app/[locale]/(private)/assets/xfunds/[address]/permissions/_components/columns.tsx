...
import { fundRevokeRoleAction } from "@/lib/mutations/asset/access-control/revoke-role/revoke-role-action";
import { fundUpdatePermissionsAction } from "@/lib/mutations/asset/access-control/update-role/update-roles-action";
            ...
            actions={[
              {
                ...
                component: ({ open, onOpenChange }) => (
                  <EditPermissionsForm
                    ...
                    updateRolesAction={fundUpdatePermissionsAction}
              ...
              },
              {
                ...
                component: ({ open, onOpenChange }) => (
                  <RevokeAllPermissionsForm
                    ...
                    open={open}
                    onOpenChange={onOpenChange}
                    revokeRoleAction={fundRevokeRoleAction}
                  />
                ),
