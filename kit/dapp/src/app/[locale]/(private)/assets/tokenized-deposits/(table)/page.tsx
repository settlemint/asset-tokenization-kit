...
export async function generateMetadata({
  ...
  const t = await getTranslations({
    locale,
    namespace: "admin.tokenized-deposits.table",
  });
...
export default async function TokenizedDepositsPage() {
  const t = await getTranslations("admin.tokenized-deposits.table");
  const tokenizedDeposits = await getTokenizedDepositList();
