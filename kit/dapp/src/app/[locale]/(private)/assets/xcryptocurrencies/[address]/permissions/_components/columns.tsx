...
import { cryptoCurrencyUpdatePermissionsAction } from "@/lib/mutations/asset/access-control/update-role/update-roles-action";
            ...
            actions={[
              {
                ...
                component: ({ open, onOpenChange }) => (
                  <EditPermissionsForm
                    ...
                    updateRolesAction={cryptoCurrencyUpdatePermissionsAction}
