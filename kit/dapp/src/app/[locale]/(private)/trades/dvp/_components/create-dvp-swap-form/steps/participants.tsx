  ...
  return (
    ...
    >
      <FormAssets
        ...
        // description={t("asset-to-send")}
        required
        // Clear amount if asset changes
      ...
      <FormAssets
        ...
        // description={t("asset-to-receive")}
        required
        // Clear amount if asset changes
        onSelect={() => setValue("amountToReceive", 0)}
        className="mb-4"
      />
      {assetToReceive && (
        <FormInput
          ...
          // description={t("amount-to-receive")}
          required
          type="number"
