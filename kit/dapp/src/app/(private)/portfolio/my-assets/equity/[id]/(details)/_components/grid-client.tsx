      ...
      itemsAction={(asset: Fund) => {
        return (
          <>
            ...
            <AssetDetailGridItem label="Fund category">{asset.fundCategory}</AssetDetailGridItem>
            <AssetDetailGridItem label="Fund class">{asset.fundClass}</AssetDetailGridItem>
          </>
        );
      }}
      dataAction={getFund}
