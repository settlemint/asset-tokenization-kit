...
interface EventsBarChartSkeletonProps extends VariantProps<typeof circleVariants> {
  categories?: number;
}

export function EventsBarChartSkeleton({ variant = 'loading', categories = 5 }: EventsBarChartSkeletonProps) {
  return (
