...
export function Summary({ address, decimals }: { address: Address; decimals: number }) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="font-semibold text-base">Review and confirm Withdrawal</h2>
        <p className="text-muted-foreground text-xs">
          Verify the details of your withdrawal before proceeding. Ensure the recipient address is correct.
        </p>
      </div>
        ...
        <div className="rounded-lg border bg-card p-4">
          ...
          <dl className="space-y-2 [&>div:last-child]:border-0 [&>div]:border-b">
            ...
            <div className="flex justify-between py-1.5">
              ...
              <dd className="font-medium text-sm">
                <EvmAddress address={values.to as Address} />
              </dd>
            </div>
          </dl>
        </div>
