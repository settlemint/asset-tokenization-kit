...
import type { TopUpFormType } from '../schema';

export function Summary({
  address,
  decimals,
  underlyingAssetAddress,
}: { address: Address; decimals: number; underlyingAssetAddress: Address }) {
  const { control } = useFormContext<TopUpFormType>();
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="font-semibold text-base">Review and confirm Top-Up</h2>
        <p className="text-muted-foreground text-xs">
          Verify the details of your top-up before proceeding. Ensure the amount is correct.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-lg border bg-card p-4">
          ...
          <AssetFormInput
            ...
            type="hidden"
            defaultValue={underlyingAssetAddress}
          />
