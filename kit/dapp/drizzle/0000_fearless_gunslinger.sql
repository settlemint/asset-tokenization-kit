CREATE TYPE "public"."currency" AS ENUM('EUR', 'USD', 'GBP', 'CHF', 'JPY', 'AED', 'SGD', 'SAR');--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "mica_regulation_configs" ADD CONSTRAINT "mica_regulation_configs_regulation_config_id_regulation_configs_id_fk" FOREIGN KEY ("regulation_config_id") REFERENCES "public"."regulation_configs"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "asset_price" ADD CONSTRAINT "asset_price_asset_id_asset_id_fk" FOREIGN KEY ("asset_id") REFERENCES "public"."asset"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "airdrop_distribution_recipient_idx" ON "airdrop_distribution" USING btree ("recipient");--> statement-breakpoint
CREATE INDEX "airdrop_distribution_airdrop_id_idx" ON "airdrop_distribution" USING btree ("airdrop_id");--> statement-breakpoint
CREATE INDEX "airdrop_distribution_recipient_airdrop_idx" ON "airdrop_distribution" USING btree ("recipient","airdrop_id");--> statement-breakpoint
CREATE INDEX "asset_isin_idx" ON "asset" USING btree ("isin");--> statement-breakpoint
CREATE INDEX "asset_internalid_idx" ON "asset" USING btree ("internalid");--> statement-breakpoint
CREATE INDEX "asset_price_asset_id_idx" ON "asset_price" USING btree ("asset_id");--> statement-breakpoint
CREATE INDEX "contact_name_idx" ON "contact" USING btree ("name");--> statement-breakpoint
CREATE INDEX "contact_wallet_idx" ON "contact" USING btree ("wallet");--> statement-breakpoint
...
CREATE INDEX "passkey_credential_id_idx" ON "passkey" USING btree ("credential_i_d");--> statement-breakpoint
...
CREATE INDEX "user_wallet_idx" ON "user" USING btree ("wallet");--> statement-breakpoint
CREATE INDEX "user_currency_idx" ON "user" USING btree ("currency");--> statement-breakpoint
...
CREATE INDEX "user_kyc_verified_at_idx" ON "user" USING btree ("kyc_verified_at");--> statement-breakpoint
...
CREATE INDEX "exchange_rate_quote_currency_idx" ON "exchange_rate" USING btree ("quote_currency");--> statement-breakpoint
CREATE INDEX "exchange_rate_day_idx" ON "exchange_rate" USING btree ("day");--> statement-breakpoint
