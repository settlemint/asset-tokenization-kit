...
description:
  Hub page for ATK's layered component architecture and cross-cutting
...
The Asset Tokenization Kit consists of five interconnected layers that deliver a
complete digital asset platform with **integrated lifecycle management**. Each
layer serves a distinct role while maintaining tight integration through shared
types, unified configuration, and a consistent control plane.
...
vault contracts, and automated distributions through yield schedules.
