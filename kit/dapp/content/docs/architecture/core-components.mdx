...
<Mermaid
  chart={`flowchart TB
    ...
    subgraph BlockchainTier("Blockchain Tier")
...
<Mermaid
  chart={`flowchart TB
    subgraph SmartContractLayer("Smart Contract Layer")
...
<Mermaid
  chart={`flowchart TB
    subgraph TestingInfrastructure("Testing Infrastructure")
...
- [DALP lifecycle overview](../executive-overview/dalp-solution) — Detailed DvP
  settlement mechanics, vault custody workflows, and yield automation scheduling
- [Observability and monitoring](../developer-guides/deployment-ops/observability-monitoring)
  — Dashboard reference, alerting rules, metric definitions, and troubleshooting
  workflows
