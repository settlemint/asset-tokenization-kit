...
description:
  Production monitoring, incident response, and disaster recovery architecture
  for ATK deployments
...
Production ATK deployments require comprehensive observability to detect issues
proactively and disaster recovery capabilities to restore service after
failures. This architecture spans application metrics, blockchain monitoring,
...
ATK's observability and recovery architecture provides:

- **Unified metrics collection**: Prometheus aggregates metrics from all
  components with consistent labeling
- **Distributed tracing**: OpenTelemetry traces requests from frontend through
  API to blockchain
- **Proactive alerting**: Alert rules detect anomalies before they impact users
...
<Mermaid
  chart={`flowchart TB
    ...
    style Prometheus fill:#d97706,stroke:#92400e,stroke-width:2px,color:#fff
    style Grafana fill:#10b981,stroke:#047857,stroke-width:2px,color:#fff
    style Alertmanager fill:#8b5cf6,stroke:#6d28d9,stroke-width:2px,color:#fff
`}
/>
...
<Mermaid
  chart={`flowchart TB
    ...
    style ProdData fill:#0ea5e9,stroke:#0369a1,stroke-width:2px,color:#fff
    style DBBackup fill:#10b981,stroke:#047857,stroke-width:2px,color:#fff
    style Runbook4 fill:#d97706,stroke:#92400e,stroke-width:2px,color:#fff
`}
/>
...
<Mermaid
  chart={`flowchart LR
    ...
    style Alert fill:#d97706,stroke:#92400e,stroke-width:2px,color:#fff
    style Verify fill:#10b981,stroke:#047857,stroke-width:2px,color:#fff
`}
/>
...
- [Performance & scalability](./performance-scalability) - Capacity planning and
