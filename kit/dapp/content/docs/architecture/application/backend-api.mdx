...
flowchart TB
    ...
    style Route fill:#0ea5e9,stroke:#0369a1,color:#fff
    style Middleware fill:#d97706,stroke:#92400e,color:#fff
    style Handler fill:#10b981,stroke:#047857,color:#fff
...
flowchart TB
    ...
    style Public fill:#0ea5e9,stroke:#0369a1,color:#fff
    style Auth fill:#d97706,stroke:#92400e,color:#fff
    style Onboarded fill:#10b981,stroke:#047857,color:#fff
    style Token fill:#10b981,stroke:#047857,color:#fff
...
See [Performance & scalability](../quality-performance/performance-scalability)
