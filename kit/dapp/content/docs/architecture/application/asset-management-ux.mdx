...
flowchart TB
    ...
    style TypeSelect fill:#6ba4d4,stroke:#4a7ba8,stroke-width:2px,color:#fff
    style BasicInfo fill:#6ba4d4,stroke:#4a7ba8,stroke-width:2px,color:#fff
    style Compliance fill:#b661d9,stroke:#8a3fb3,stroke-width:2px,color:#fff
    style Features fill:#8571d9,stroke:#654bad,stroke-width:2px,color:#fff
    style Review fill:#8571d9,stroke:#654bad,stroke-width:2px,color:#fff
    style Deploy fill:#b661d9,stroke:#8a3fb3,stroke-width:2px,color:#fff
...
flowchart TB
    ...
    style Application fill:#6ba4d4,stroke:#4a7ba8,stroke-width:2px,color:#fff
    style Queue fill:#8571d9,stroke:#654bad,stroke-width:2px,color:#fff
    style Decision fill:#8571d9,stroke:#654bad,stroke-width:2px,color:#fff
