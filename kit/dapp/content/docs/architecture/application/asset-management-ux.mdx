...
flowchart TB
    ...
    style TypeSelect fill:#0ea5e9,stroke:#0369a1,color:#fff
    style BasicInfo fill:#0ea5e9,stroke:#0369a1,color:#fff
...
- Dividend policy (automatic distribution, claimable)
...
flowchart LR
    ...
    style Supply fill:#0ea5e9,stroke:#0369a1,color:#fff
    style Holders fill:#0ea5e9,stroke:#0369a1,color:#fff
    style Value fill:#10b981,stroke:#047857,color:#fff
    style Compliance fill:#10b981,stroke:#047857,color:#fff
...
- Link to bank account for automatic funding
- Set up notifications (email holders before payment)
...
flowchart TB
    ...
    style Application fill:#0ea5e9,stroke:#0369a1,color:#fff
    style Queue fill:#8b5cf6,stroke:#6d28d9,color:#fff
    style Approve fill:#10b981,stroke:#047857,color:#fff
    style Reject fill:#d97706,stroke:#92400e,color:#fff
    style Identity fill:#10b981,stroke:#047857,color:#fff
    style Eligible fill:#10b981,stroke:#047857,color:#fff
...
7. Submit transaction:
   ...
   - Each holder can claim their portion
   - Or system pushes to holder wallets automatically
