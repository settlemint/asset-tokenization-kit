...
<Mermaid
  chart={`flowchart TB
    ...
    style Users fill:#8b5cf6,stroke:#6d28d9,stroke-width:2px,color:#fff
    style KYCApp fill:#10b981,stroke:#047857,stroke-width:2px,color:#fff
    style Rates fill:#0ea5e9,stroke:#0369a1,stroke-width:2px,color:#fff
`}
/>
