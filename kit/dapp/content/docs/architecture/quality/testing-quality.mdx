...
flowchart TB
    subgraph "Testing Pyramid"
        ...
        Static("Static Analysis<br/>TypeScript, Solhint, Oxlint<br/>Code quality")
    end
...
**Oxlint and Solhint** - Linters enforce code quality rules across TypeScript
...
| **Linting**             | Oxlint (TS), Solhint (Sol)   | Zero warnings          | ✅            |
