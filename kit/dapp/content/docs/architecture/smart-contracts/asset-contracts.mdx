...
description:
  ATK Assets are tokenization contracts that represent real-world assets (RWAs)
  as compliant security tokens. Built on the SMART Protocol foundation, each
  asset type provides specific functionality for different financial instruments
