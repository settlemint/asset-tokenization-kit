...
description:
  The Asset Tokenization Kit implements a unified Digital Asset Lifecycle
  Platform (DALP) architecture that addresses the fragmentation plaguing
  traditional tokenization approaches. Rather than relying on disparate vendor
  tools cobbled together through manual processes, ATK provides a single control
  plane where every lifecycle event—from issuance through settlement to
  reporting—flows through orchestrated services backed by compliance-first
  design.
...
calculation of dividends, interest, and coupon entitlements. Configure once;
calculate entitlements automatically on payment dates for on-demand claiming
...
<Mermaid
  chart={`flowchart TB
    ...
    style UI fill:#5fc9bf,stroke:#3a9d96,stroke-width:2px,color:#fff
    style Mobile fill:#5fc9bf,stroke:#3a9d96,stroke-width:2px,color:#fff
    style Admin fill:#5fc9bf,stroke:#3a9d96,stroke-width:2px,color:#fff
    style ORPC fill:#8571d9,stroke:#654bad,stroke-width:2px,color:#fff
    style Auth fill:#8571d9,stroke:#654bad,stroke-width:2px,color:#fff
    style Middleware fill:#8571d9,stroke:#654bad,stroke-width:2px,color:#fff
    style AssetMgmt fill:#6ba4d4,stroke:#4a7ba8,stroke-width:2px,color:#fff
    ...
    style Addon fill:#6ba4d4,stroke:#4a7ba8,stroke-width:2px,color:#fff
    style PostgreSQL fill:#5fc9bf,stroke:#3a9d96,stroke-width:2px,color:#fff
    style Redis fill:#5fc9bf,stroke:#3a9d96,stroke-width:2px,color:#fff
    style MinIO fill:#5fc9bf,stroke:#3a9d96,stroke-width:2px,color:#fff
    style Subgraph fill:#5fc9bf,stroke:#3a9d96,stroke-width:2px,color:#fff
    style ATKSystem fill:#b661d9,stroke:#8a3fb3,stroke-width:2px,color:#fff
    style SMART fill:#b661d9,stroke:#8a3fb3,stroke-width:2px,color:#fff
    style Assets fill:#b661d9,stroke:#8a3fb3,stroke-width:2px,color:#fff
    style Addons fill:#b661d9,stroke:#8a3fb3,stroke-width:2px,color:#fff
    style Blockchain fill:#8571d9,stroke:#654bad,stroke-width:2px,color:#fff
    style IPFS fill:#8571d9,stroke:#654bad,stroke-width:2px,color:#fff
    style Portal fill:#8571d9,stroke:#654bad,stroke-width:2px,color:#fff`}
  ...
  chart={`flowchart TB
    ...
    subgraph "Kit Directory"
        ...
        subgraph "Application Components"
            ...
            SubgraphNode(subgraph/<br/>Blockchain Indexer)
    ...
    subgraph "Shared Packages"
        ConfigPkg(config/<br/>Oxlint Configuration)
    ...
    DApp -.-> Contracts
    SubgraphNode -.-> Contracts
    E2E -.-> DApp

    style Root fill:#5fc9bf,stroke:#3a9d96,stroke-width:2px,color:#fff
    style Config fill:#6ba4d4,stroke:#4a7ba8,stroke-width:2px,color:#fff
    style Tools fill:#6ba4d4,stroke:#4a7ba8,stroke-width:2px,color:#fff
    style Packages fill:#6ba4d4,stroke:#4a7ba8,stroke-width:2px,color:#fff
    style Kit fill:#8571d9,stroke:#654bad,stroke-width:2px,color:#fff
    style Contracts fill:#6ba4d4,stroke:#4a7ba8,stroke-width:2px,color:#fff
    style DApp fill:#b661d9,stroke:#8a3fb3,stroke-width:2px,color:#fff
    style SubgraphNode fill:#6ba4d4,stroke:#4a7ba8,stroke-width:2px,color:#fff
    style E2E fill:#8571d9,stroke:#654bad,stroke-width:2px,color:#fff
    style Charts fill:#8571d9,stroke:#654bad,stroke-width:2px,color:#fff
    style ConfigPkg fill:#5fc9bf,stroke:#3a9d96,stroke-width:2px,color:#fff
    style ZodPkg fill:#5fc9bf,stroke:#3a9d96,stroke-width:2px,color:#fff
    style TypeScript fill:#5fc9bf,stroke:#3a9d96,stroke-width:2px,color:#fff`}
...
<Mermaid
  chart={`flowchart TB
    ...
    style Bond fill:#5fc9bf,stroke:#3a9d96,stroke-width:2px,color:#fff
    style Equity fill:#8571d9,stroke:#654bad,stroke-width:2px,color:#fff
    style Fund fill:#6ba4d4,stroke:#4a7ba8,stroke-width:2px,color:#fff
    style Stable fill:#b661d9,stroke:#8a3fb3,stroke-width:2px,color:#fff
    ...
    style Extensions fill:#6ba4d4,stroke:#4a7ba8,stroke-width:2px,color:#fff
    style Governance fill:#b661d9,stroke:#8a3fb3,stroke-width:2px,color:#fff`}
