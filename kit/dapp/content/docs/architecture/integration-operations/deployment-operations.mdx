...
[Developer environment guide](/docs/developer-guides/setup).
...
<Mermaid
  chart={`flowchart TB
    ...
    style Network fill:#6ba4d4,stroke:#4a7ba8,stroke-width:2px,color:#fff
    style PostgreSQL fill:#b661d9,stroke:#8a3fb3,stroke-width:2px,color:#fff`}
/>
...
<Mermaid
  chart={`flowchart TB
    ...
    style ATKHelm fill:#5fc9bf,stroke:#3a9d96,stroke-width:2px,color:#fff
...
<Mermaid
  chart={`flowchart TB
    ...
    style DevCluster fill:#b661d9,stroke:#8a3fb3,stroke-width:2px,color:#fff
    style StagingCluster fill:#6ba4d4,stroke:#4a7ba8,stroke-width:2px,color:#fff
    style ProdCluster fill:#5fc9bf,stroke:#3a9d96,stroke-width:2px,color:#fff`}
/>
...
- **Review [Scalability patterns](../performance/scalability-architecture)** for
  capacity planning
