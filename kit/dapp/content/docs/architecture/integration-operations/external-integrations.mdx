...
description:
  Open-source integration patterns for KYC, exchange rates, banking, and storage
  providers
...
The Asset Tokenization Kit is designed as an **open-source platform** that
expects implementation partners and clients to integrate their own external
service providers. Rather than prescribing specific vendors, ATK provides clean
integration points and reference implementations that organizations can adapt to
their compliance, operational, and commercial requirements.
...
<Mermaid
  chart={`flowchart TB
    ...
    style ATK fill:#8b5cf6,stroke:#6d28d9,stroke-width:2px,color:#fff
    style KYC fill:#10b981,stroke:#047857,stroke-width:2px,color:#fff
    style Banking fill:#0ea5e9,stroke:#0369a1,stroke-width:2px,color:#fff
    style ExchangeRate fill:#d97706,stroke:#92400e,stroke-width:2px,color:#fff
    style FileStorage fill:#10b981,stroke:#047857,stroke-width:2px,color:#fff`}
/>
...
<Mermaid
  chart={`flowchart LR
    ...
    style Token fill:#8b5cf6,stroke:#6d28d9,stroke-width:2px,color:#fff
    style Mediator fill:#0ea5e9,stroke:#0369a1,stroke-width:2px,color:#fff
    style Banking fill:#10b981,stroke:#047857,stroke-width:2px,color:#fff`}
/>
