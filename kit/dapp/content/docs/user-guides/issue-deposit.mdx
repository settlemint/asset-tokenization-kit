...
- **Maximum transfers** - Limit to 6 withdrawals/transfers per month
...
- **Per-depositor limit** - Enforce FDIC insurance cap ($250,000)
- **Aggregation** - Combine deposits across products for insurance calculation

![Compliance module configuration](/images/screenshots/placeholder.svg)
_Screenshot: Compliance modules showing Depositor Eligibility requirements,
Transfer Restrictions including Reg D limits, and insurance cap enforcement_

**Regulation D important:** Federal Reserve Regulation D historically limited
convenient transfers from savings deposits to 6 per month.
