...
Choose backing structure:

- **Fully reserved** - 100% fiat backing (1:1 reserve ratio)
- **Overcollateralized** - &gt;100% reserves for added security
- **Fractional reserve** - &lt;100% reserves with additional risk management
...
input, and collateralization model selector with ratio input_

**Regulatory requirement:** Most e-money regulations require 100% or
...
### Execute reserve attestations

Publish transparency reports:

**Automated attestation:**

If configured, platform automatically:

1. Triggers attestation service at scheduled frequency
2. Attestor verifies reserve balances (on-chain and off-chain)
3. Attestor publishes signed attestation report
4. Platform posts attestation hash on-chain
5. Updates **Attestation** tab with latest report

**Manual attestation:**

1. Receive attestation report from auditor
2. Navigate to **Attestation** &gt; **Post Report**
3. Upload attestation PDF
4. Enter attestation date and report hash
5. Click **Publish Attestation**
6. Share report link with community

**Transparency requirement:** Most stablecoin regulations require monthly or
quarterly attestation publication.
...
- **Set up monitoring** - Configure [Fiat bridge](/docs/user-guides/fiat-bridge)
  for banking integration and redemption processing
- **Configure compliance** - Review
  [Manage investors](/docs/user-guides/manage-investors) for KYC/AML workflows
