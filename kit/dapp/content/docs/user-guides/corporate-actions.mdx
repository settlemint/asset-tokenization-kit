...
Your corporate action is recorded on-chain with complete holder snapshots and
transaction history for audit and regulatory compliance.
...
- [Issue a bond](/docs/user-guides/issue-bond) - Configure bond-specific actions
  like coupon payments and redemptions
- [Issue equity](/docs/user-guides/issue-equity) - Set up equity governance and
  shareholder voting
- [Issue a fund](/docs/user-guides/issue-fund) - Execute NAV updates and fund
  income distributions
- [Manage investors](/docs/user-guides/manage-investors) - Communicate with
  shareholders about corporate actions
