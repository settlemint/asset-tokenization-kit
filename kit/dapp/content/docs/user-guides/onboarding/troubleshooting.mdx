...
Find quick solutions to common issues encountered when using the Asset
Tokenization Kit. This guide covers problems organized by topic area with
step-by-step troubleshooting instructions.

**Primary audience:** All platform users (investors, issuers, administrators)
**Secondary audience:** Support teams, compliance officers

## How to use this guide

1. **Identify your problem category** - Scan the section headers to find your
   issue type
2. **Follow the solutions** - Try each solution in order until resolved
3. **Check error messages** - Use the Error Messages Reference section for
   specific errors
4. **Escalate if needed** - Contact support if solutions don't resolve your
   issue

**Tip:** Use your browser's search (Ctrl+F / Cmd+F) to quickly find keywords
...
<Accordion title="Cannot access platform or login fails">
...
<Accordion title="Wallet creation fails during onboarding">
...
<Accordion title="OnchainID deployment stuck or fails">
...
<Accordion title="Cannot complete onboarding - stuck on system deployment step">
