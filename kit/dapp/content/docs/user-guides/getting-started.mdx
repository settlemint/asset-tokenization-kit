...
<Mermaid
  ...
  style Complete fill:#5fc9bf,stroke:#3a9d96,stroke-width:2px,color:#fff
  style Done fill:#5fc9bf,stroke:#3a9d96,stroke-width:2px,color:#fff
  style Wallet fill:#8571d9,stroke:#654bad,stroke-width:2px,color:#fff
