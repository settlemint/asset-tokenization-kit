...
<Mermaid
  chart={
    "graph TB\n    A[Configure Bond&lt;br/&gt;Parameters] --&gt; B[Set Compliance&lt;br/&gt;Rules]\n    B --&gt; C[Assign Operational&lt;br/&gt;Roles]\n    C --&gt; D[Deploy Bond&lt;br/&gt;Contract]\n    D --&gt; E[Mint Initial&lt;br/&gt;Allocation]\n    E --&gt; F{Yield Enabled?}\n    F --&gt;|Yes| G[Fund Yield&lt;br/&gt;Wallet]\n    F --&gt;|No| H[Monitor Lifecycle]\n    G --&gt; I[Process Coupon&lt;br/&gt;Payments]\n    I --&gt; J{Maturity Date&lt;br/&gt;Reached?}\n    J --&gt;|No| I\n    J --&gt;|Yes| K[Execute Maturation]\n    H --&gt; J\n    K --&gt; L[Handle Redemptions]\n    L --&gt; M[Bond Lifecycle&lt;br/&gt;Complete]\n    style A fill:#0EA5E9\n    style D fill:#0EA5E9\n    style E fill:#0EA5E9\n    style I fill:#10B981\n    style K fill:#10B981\n    style L fill:#10B981\n    style M fill:#6366F1"
  }
/>
...
You can enable automated interest/coupon payments through the yield add-on.

**Note:** The yield module is an optional add-on. You must explicitly enable it
during bond creation. Bonds deployed without this add-on cannot distribute
...
1. The contract snapshots current token holders
2. Calculates yield owed: (tokens held × face value × rate × time elapsed)
3. Transfers yield tokens from your designated yield wallet
...
Track your automated coupon payments:
...
- (Optional) Funded yield wallet for automated coupon payments
...
compliance rules. If you enabled the yield add-on, coupon payments will
distribute automatically on your configured schedule.
...
- Redeploy with the yield add-on enabled if automated coupon payments are
  required
...
- [Corporate actions](/docs/user-guides/corporate-actions) - Execute dividends,
  splits, and other lifecycle events
- [Manage investors](/docs/user-guides/manage-investors) - Onboard new
  bondholders and verify identities
- [Fiat bridge](/docs/user-guides/fiat-bridge) - Configure traditional payment
  rails for coupon distributions
