...
style Invite fill:#6ba4d4,stroke:#4a7ba8,stroke-width:2px
style Approve fill:#b661d9,stroke:#8a3fb3,stroke-width:2px
style DeployID fill:#8571d9,stroke:#654bad,stroke-width:2px
style IssueClaims fill:#5fc9bf,stroke:#3a9d96,stroke-width:2px
style Monitor fill:#6ba4d4,stroke:#4a7ba8,stroke-width:2px
`} />
...
- **Registered** - Identity successfully registered on-chain and ready for use
  in workflows.
- **Pending registration** - Identity invited or created but awaiting
  registration to complete onboarding.
...
**DOB validation:** The participant edit workflow only stores dates of birth
that parse to a valid calendar date, so malformed inputs are ignored until
corrected.
...
> > > > > > > origin/main
> > > > > > > style Route fill:#b661d9,stroke:#8a3fb3,stroke-width:2px
> > > > > > > style Provider fill:#5fc9bf,stroke:#3a9d96,stroke-width:2px
> > > > > > > style Manual fill:#6ba4d4,stroke:#4a7ba8,stroke-width:2px
> > > > > > > style Level fill:#b661d9,stroke:#8a3fb3,stroke-width:2px
> > > > > > > style Approved fill:#8571d9,stroke:#654bad,stroke-width:2px
> > > > > > > `} />
...
**Contract linkage:** Non-contract identities skip token prefetch until an
account contract exists, so token tiles stay blank until linkage is provisioned.
...
accreditation verification, allowing you to batch-issue renewed ACCREDITED_INVESTOR claims to all qualifying investors.
...
style Check fill:#b661d9,stroke:#8a3fb3,stroke-width:2px
style Valid fill:#5fc9bf,stroke:#3a9d96,stroke-width:2px
style Warn fill:#6ba4d4,stroke:#4a7ba8,stroke-width:2px
style Block fill:#8571d9,stroke:#654bad,stroke-width:2px
style Freeze fill:#b661d9,stroke:#8a3fb3,stroke-width:2px`} />
...
style Match fill:#b661d9,stroke:#8a3fb3,stroke-width:2px
style Classify fill:#b661d9,stroke:#8a3fb3,stroke-width:2px
style Enforce fill:#8571d9,stroke:#654bad,stroke-width:2px
style Alert fill:#b661d9,stroke:#8a3fb3,stroke-width:2px
style SAR fill:#5fc9bf,stroke:#3a9d96,stroke-width:2px
`} />
