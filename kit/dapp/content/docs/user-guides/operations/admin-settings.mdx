...
style Access fill:#6ba4d4,stroke:#4a7ba8,stroke-width:2px,color:#fff style Roles
fill:#8571d9,stroke:#654bad,stroke-width:2px,color:#fff style Assets
fill:#8571d9,stroke:#654bad,stroke-width:2px,color:#fff style Addons
...
The onboarding wizard now renders these same asset type cards grouped under
**Fixed Income**, **Flexible Income**, and **Cash Equivalent**, so admins see
identical icons, descriptions, and extension details during initial setup and
ongoing management.
...
- Yield - Scheduled interest/dividend calculations (required for bonds)
