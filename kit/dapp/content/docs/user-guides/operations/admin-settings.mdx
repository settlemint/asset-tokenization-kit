...
<Mermaid
  ...
  style Access fill:#6ba4d4,stroke:#4a7ba8,stroke-width:2px,color:#fff
  ...
  style Addons fill:#8571d9,stroke:#654bad,stroke-width:2px,color:#fff
...
All Platform Settings pages now render in a full-width workspace so previews,
tables, and alerts stay visible side by side.
