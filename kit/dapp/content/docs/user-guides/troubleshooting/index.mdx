...
description:
  Common issues across wallet access, investor onboarding, transactions, and
  compliance with links to targeted fixes.
...
operators encounter across the platform. Use the sections below to jump directly
to deep-dive fixes:
