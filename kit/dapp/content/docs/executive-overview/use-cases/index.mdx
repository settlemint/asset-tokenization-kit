...
- **Scheduled corporate actions** – Coupon entitlements, distributions,
  redemptions, and fee calculations execute on schedule without manual
  spreadsheet work; token holders claim distributions on-demand
