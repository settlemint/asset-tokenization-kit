...
flowchart TB
    ...
    style SMART fill:#0ea5e9,stroke:#0369a1,stroke-width:2px,color:#fff
    style BONDS fill:#10b981,stroke:#047857,stroke-width:2px,color:#fff
    style PE fill:#10b981,stroke:#047857,stroke-width:2px,color:#fff
    style RE fill:#10b981,stroke:#047857,stroke-width:2px,color:#fff
