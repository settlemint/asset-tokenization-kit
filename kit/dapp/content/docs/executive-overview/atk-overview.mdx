...
flowchart TB
    ...
    style UI1 fill:#8571d9,stroke:#654bad,stroke-width:2px,color:#fff
    style UI2 fill:#8571d9,stroke:#654bad,stroke-width:2px,color:#fff
    style UI3 fill:#8571d9,stroke:#654bad,stroke-width:2px,color:#fff
    style UI4 fill:#8571d9,stroke:#654bad,stroke-width:2px,color:#fff
    
    style ORPC fill:#6ba4d4,stroke:#4a7ba8,stroke-width:2px,color:#fff
    style BL fill:#6ba4d4,stroke:#4a7ba8,stroke-width:2px,color:#fff
    
    style BC1 fill:#5fc9bf,stroke:#3a9d96,stroke-width:2px,color:#fff
    style BC2 fill:#5fc9bf,stroke:#3a9d96,stroke-width:2px,color:#fff
    style BC3 fill:#5fc9bf,stroke:#3a9d96,stroke-width:2px,color:#fff
    style BC4 fill:#5fc9bf,stroke:#3a9d96,stroke-width:2px,color:#fff
    
    style DB fill:#6ba4d4,stroke:#4a7ba8,stroke-width:2px,color:#fff
    style CACHE fill:#6ba4d4,stroke:#4a7ba8,stroke-width:2px,color:#fff
    style IDX fill:#6ba4d4,stroke:#4a7ba8,stroke-width:2px,color:#fff
    
    style EXT1 fill:#8571d9,stroke:#654bad,stroke-width:2px,color:#fff
    style EXT2 fill:#8571d9,stroke:#654bad,stroke-width:2px,color:#fff
    style EXT3 fill:#8571d9,stroke:#654bad,stroke-width:2px,color:#fff
    style EXT4 fill:#8571d9,stroke:#654bad,stroke-width:2px,color:#fff
`}
/>
