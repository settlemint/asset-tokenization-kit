...
description:
  High-level architecture of the ATK data layer with database and subgraph
  entities
...
provides fast access to user data while maintaining an immutable audit trail of
...
**[Token entities reference →](/developer-guides/data-model/entity-token)**
...
**[Investor entities reference →](/developer-guides/data-model/entity-investor)**
...
**[Compliance entities reference →](/developer-guides/data-model/entity-compliance)**
...
**[Corporate action entities reference →](/developer-guides/data-model/entity-corporate-actions)**
...
- **[Token entities](/developer-guides/data-model/entity-token)** - Security
  tokens and balances
- **[Investor entities](/developer-guides/data-model/entity-investor)** - Users
  and identities
...
- **[API Reference](/developer-guides/api-integration/api-reference)** - Query
