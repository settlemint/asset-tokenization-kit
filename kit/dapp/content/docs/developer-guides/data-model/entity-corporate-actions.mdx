...
description: Dividends, voting proposals, and other corporate actions for token holders
...
- **[Token entities](/docs/developer-guides/data-model/entity-token)** -
  Security tokens affected by corporate actions
- **[Investor entities](/docs/developer-guides/data-model/entity-investor)** -
  Token holders eligible for dividends/voting
