...
| **drizzle-gateway**     | 4983 | Drizzle Studio database gateway           |
...
The Drizzle Gateway provides a web interface to browse tables, run queries, and
inspect your database schema. Connect to your database using the connection
string from your environment configuration.
