...
2. **Check documentation**: [Developer Guides](./dev-environment)
...
- Review [Development Environment](./dev-environment) for setup details
- See [Testing and QA](./testing-qa) for debugging test failures
- Explore [Deployment Guide](./deployment-guide) for production issues
- Consult [Code Structure](./code-structure) for architecture understanding
