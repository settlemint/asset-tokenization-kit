...
- Review [Installation & configuration](./installation-configuration) for
  initial setup and configuration reference
- See [Testing and QA](./testing-qa) for running tests against deployed
  environments
- Explore [Development FAQ](./dev-faq) for common deployment issues
- Consult [Code Structure](./code-structure) to understand the monorepo layout
- Review [Contract Reference](./contract-reference) for smart contract
  interfaces
