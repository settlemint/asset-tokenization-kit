...
<Mermaid
  chart={`graph TB
    ...
    style F fill:#0ea5e9,stroke:#0369a1,stroke-width:2px,color:#fff
`}
/>
...
- **Build API endpoints**: [Using the API](/developer-guides/using-api)
- **Deploy to production**:
  [Deployment guide](/developer-guides/deployment-guide)
- **Run tests**: [Testing and QA](/developer-guides/testing-qa)
