...
All contract source code is in
[`kit/contracts/contracts/`](https://github.com/settlemint/asset-tokenization-kit/tree/main/kit/contracts/contracts).
...
**Location**:
[`IATKToken.sol`](https://github.com/settlemint/asset-tokenization-kit/blob/main/kit/contracts/contracts/system/tokens/IATKToken.sol)
...
**Location**:
[`ISMART.sol`](https://github.com/settlemint/asset-tokenization-kit/blob/main/kit/contracts/contracts/smart/interface/ISMART.sol)
...
**Location**:
[`IATKBond.sol`](https://github.com/settlemint/asset-tokenization-kit/blob/main/kit/contracts/contracts/assets/bond/IATKBond.sol)
...
**Location**:
[`ISMARTBurnable.sol`](https://github.com/settlemint/asset-tokenization-kit/blob/main/kit/contracts/contracts/smart/extensions/burnable/ISMARTBurnable.sol)
...
**Location**:
[`ISMARTPausable.sol`](https://github.com/settlemint/asset-tokenization-kit/blob/main/kit/contracts/contracts/smart/extensions/pausable/ISMARTPausable.sol)
...
**Location**:
[`ISMARTCustodian.sol`](https://github.com/settlemint/asset-tokenization-kit/blob/main/kit/contracts/contracts/smart/extensions/custodian/ISMARTCustodian.sol)
...
**Location**:
[`ISMARTComplianceModule.sol`](https://github.com/settlemint/asset-tokenization-kit/blob/main/kit/contracts/contracts/smart/interface/ISMARTComplianceModule.sol)
...
**Location**:
[`ATKAssetRoles.sol`](https://github.com/settlemint/asset-tokenization-kit/blob/main/kit/contracts/contracts/assets/ATKAssetRoles.sol)
...
[`kit/dapp/src/lib/contracts/`](https://github.com/settlemint/asset-tokenization-kit/tree/main/kit/dapp/src/lib/contracts)
after running `bun run artifacts` in
[`kit/contracts/`](https://github.com/settlemint/asset-tokenization-kit/tree/main/kit/contracts).
...
- **Review data models**: See
  [Data Model Reference](/developer-guides/data-model/data-model-reference) for
  off-chain schemas
- **Study deployment**: Check
  [Deployment Guide](/developer-guides/deployment-ops/deployment-guide) for
  production setup
