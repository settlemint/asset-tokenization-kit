...
declare module 'gql.tada' {
 interface setupCache {
    ...
    "\n  fragment AssetsFragment on Asset {\n    symbol\n    name\n    id\n  }\n":
      TadaDocumentNode<{ __typename?: "Bond" | undefined; symbol: string; name: string; id: string; } | { __typename?: "CryptoCurrency" | undefined; symbol: string; name: string; id: string; } | { __typename?: "Equity" | undefined; symbol: string; name: string; id: string; } | { __typename?: "Fund" | undefined; symbol: string; name: string; id: string; } | { __typename?: "StableCoin" | undefined; symbol: string; name: string; id: string; }, {}, { fragment: "AssetsFragment"; on: "Asset"; masked: false; }>;
    "\n  query NavigationQuery {\n    stableCoins(orderBy: totalSupplyExact, orderDirection: desc) {\n      ...AssetsFragment\n    }\n    equities(orderBy: totalSupplyExact, orderDirection: desc) {\n      ...AssetsFragment\n    }\n    bonds(orderBy: totalSupplyExact, orderDirection: desc) {\n      ...AssetsFragment\n    }\n    cryptoCurrencies(orderBy: totalSupplyExact, orderDirection: desc) {\n      ...AssetsFragment\n    }\n    funds(orderBy: totalSupplyExact, orderDirection: desc) {\n      ...AssetsFragment\n    }\n  }\n":
      TadaDocumentNode<{ stableCoins: { __typename?: "StableCoin" | undefined; symbol: string; name: string; id: string; }[]; equities: { __typename?: "Equity" | undefined; symbol: string; name: string; id: string; }[]; bonds: { __typename?: "Bond" | undefined; symbol: string; name: string; id: string; }[]; cryptoCurrencies: { __typename?: "CryptoCurrency" | undefined; symbol: string; name: string; id: string; }[]; funds: { __typename?: "Fund" | undefined; symbol: string; name: string; id: string; }[]; }, {}, void>;
    "\n  query Bond($id: ID!) {\n    bond(id: $id) {\n    id\n    name\n    symbol\n    decimals\n    totalSupply\n    underlyingAsset\n    redeemedAmount\n    paused\n    }\n  }\n":
