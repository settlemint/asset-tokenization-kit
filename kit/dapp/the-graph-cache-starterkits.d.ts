...
declare module 'gql.tada' {
 interface setupCache {
    ...
    "\n  fragment AssetsFragment on Asset {\n    symbol\n    name\n    id\n  }\n":
      TadaDocumentNode<{ __typename?: "Bond" | undefined; symbol: string | null; name: string | null; id: string; } | { __typename?: "CryptoCurrency" | undefined; symbol: string | null; name: string | null; id: string; } | { __typename?: "Equity" | undefined; symbol: string | null; name: string | null; id: string; } | { __typename?: "Fund" | undefined; symbol: string | null; name: string | null; id: string; } | { __typename?: "StableCoin" | undefined; symbol: string | null; name: string | null; id: string; }, {}, { fragment: "AssetsFragment"; on: "Asset"; masked: false; }>;
    "\n  query NavigationQuery {\n    stableCoins(orderBy: totalSupplyExact, orderDirection: desc) {\n      ...AssetsFragment\n    }\n    equities(orderBy: totalSupplyExact, orderDirection: desc) {\n      ...AssetsFragment\n    }\n    bonds(orderBy: totalSupplyExact, orderDirection: desc) {\n      ...AssetsFragment\n    }\n    cryptoCurrencies(orderBy: totalSupplyExact, orderDirection: desc) {\n      ...AssetsFragment\n    }\n    funds(orderBy: totalSupplyExact, orderDirection: desc) {\n      ...AssetsFragment\n    }\n  }\n":
      TadaDocumentNode<{ stableCoins: { __typename?: "StableCoin" | undefined; symbol: string | null; name: string | null; id: string; }[]; equities: { __typename?: "Equity" | undefined; symbol: string | null; name: string | null; id: string; }[]; bonds: { __typename?: "Bond" | undefined; symbol: string | null; name: string | null; id: string; }[]; cryptoCurrencies: { __typename?: "CryptoCurrency" | undefined; symbol: string | null; name: string | null; id: string; }[]; funds: { __typename?: "Fund" | undefined; symbol: string | null; name: string | null; id: string; }[]; }, {}, void>;
    "\n  query Bond($id: ID!) {\n    bond(id: $id) {\n    id\n    name\n    symbol\n    decimals\n    totalSupply\n    underlyingAsset\n    redeemedAmount\n    paused\n    }\n  }\n":
      TadaDocumentNode<{ bond: { id: string; name: string | null; symbol: string | null; decimals: number; totalSupply: string; underlyingAsset: string; redeemedAmount: string; paused: boolean; } | null; }, { id: string; }, void>;
    "\n  query Bond($id: ID!) {\n    bond(id: $id) {\n    id\n    name\n    symbol\n    }\n  }\n":
      TadaDocumentNode<{ bond: { id: string; name: string | null; symbol: string | null; } | null; }, { id: string; }, void>;
    ...
    "\n  query Cryptocurrency($id: ID!) {\n    cryptoCurrency(id: $id) {\n    id\n    name\n    symbol\n    decimals\n    totalSupply\n    }\n  }\n":
      TadaDocumentNode<{ cryptoCurrency: { id: string; name: string | null; symbol: string | null; decimals: number; totalSupply: string; } | null; }, { id: string; }, void>;
    "\n  query Cryptocurrency($id: ID!) {\n    cryptoCurrency(id: $id) {\n    id\n    name\n    symbol\n    }\n  }\n":
      TadaDocumentNode<{ cryptoCurrency: { id: string; name: string | null; symbol: string | null; } | null; }, { id: string; }, void>;
    ...
    "\n  query Equity($id: ID!) {\n    equity(id: $id) {\n     id\n    name\n    symbol\n    decimals\n    totalSupply\n    }\n  }\n":
      TadaDocumentNode<{ equity: { id: string; name: string | null; symbol: string | null; decimals: number; totalSupply: string; } | null; }, { id: string; }, void>;
    "\n  query Equity($id: ID!) {\n    equity(id: $id) {\n    id\n    name\n    symbol    }\n  }\n":
      TadaDocumentNode<{ equity: { id: string; name: string | null; symbol: string | null; } | null; }, { id: string; }, void>;
    ...
    "\n  query AddressBalances($account: String!) {\n    balances(where: {account: $account}) {\n      value\n      asset {\n        name\n        symbol\n      }\n    }\n  }\n":
      TadaDocumentNode<{ balances: { value: string; asset: { __typename?: "Bond" | undefined; name: string | null; symbol: string | null; } | { __typename?: "CryptoCurrency" | undefined; name: string | null; symbol: string | null; } | { __typename?: "Equity" | undefined; name: string | null; symbol: string | null; } | { __typename?: "Fund" | undefined; name: string | null; symbol: string | null; } | { __typename?: "StableCoin" | undefined; name: string | null; symbol: string | null; }; }[]; }, { account: string; }, void>;
    ...
    "\n  query Fund($id: ID!) {\n    fund(id: $id) {\n    id\n    name\n    symbol\n    decimals\n    totalSupply\n    fundCategory\n    fundClass\n    paused\n    }\n  }\n":
      TadaDocumentNode<{ fund: { id: string; name: string | null; symbol: string | null; decimals: number; totalSupply: string; fundCategory: string; fundClass: string; paused: boolean; } | null; }, { id: string; }, void>;
    "\n  query Fund($id: ID!) {\n    fund(id: $id) {\n     id\n    name\n    symbol\n    }\n  }\n":
      TadaDocumentNode<{ fund: { id: string; name: string | null; symbol: string | null; } | null; }, { id: string; }, void>;
    ...
    "\n  fragment FundFields on Fund {\n    id\n    name\n    symbol\n    decimals\n    totalSupply\n    fundCategory\n    fundClass\n    paused\n  }\n":
      TadaDocumentNode<{ id: string; name: string | null; symbol: string | null; decimals: number; totalSupply: string; fundCategory: string; fundClass: string; paused: boolean; }, {}, { fragment: "FundFields"; on: "Fund"; masked: false; }>;
    "\n  query Funds {\n    funds {\n      ...FundFields\n    }\n  }\n":
      TadaDocumentNode<{ funds: { id: string; name: string | null; symbol: string | null; decimals: number; totalSupply: string; fundCategory: string; fundClass: string; paused: boolean; }[]; }, {}, void>;
    "\n  query StableCoin($id: ID!) {\n    stableCoin(id: $id) {\n    id\n    name\n    symbol\n    decimals\n    totalSupply\n    }\n  }\n":
      TadaDocumentNode<{ stableCoin: { id: string; name: string | null; symbol: string | null; decimals: number; totalSupply: string; } | null; }, { id: string; }, void>;
    "\n  query StableCoin($id: ID!) {\n    stableCoin(id: $id) {\n    id\n    name\n    symbol    }\n  }\n":
      TadaDocumentNode<{ stableCoin: { id: string; name: string | null; symbol: string | null; } | null; }, { id: string; }, void>;
    ...
    "\n  query SearchAssets {\n    assets {\n      id\n      name\n      symbol\n    }\n  }\n":
      TadaDocumentNode<{ assets: ({ __typename?: "Bond" | undefined; id: string; name: string | null; symbol: string | null; } | { __typename?: "CryptoCurrency" | undefined; id: string; name: string | null; symbol: string | null; } | { __typename?: "Equity" | undefined; id: string; name: string | null; symbol: string | null; } | { __typename?: "Fund" | undefined; id: string; name: string | null; symbol: string | null; } | { __typename?: "StableCoin" | undefined; id: string; name: string | null; symbol: string | null; })[]; }, {}, void>;
  }
}
