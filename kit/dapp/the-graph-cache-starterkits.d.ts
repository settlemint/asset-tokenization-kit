...
declare module 'gql.tada' {
 interface setupCache {
    ...
    "\n  fragment BondFields on Bond {\n    id\n    name\n    symbol\n    decimals\n    totalSupply\n    isMatured\n    maturityDate\n    paused\n  }\n":
      TadaDocumentNode<{ id: string; name: string | null; symbol: string | null; decimals: number; totalSupply: string; isMatured: boolean; maturityDate: string; paused: boolean; }, {}, { fragment: "BondFields"; on: "Bond"; masked: false; }>;
    "\n  query Bonds {\n    bonds {\n      ...BondFields\n    }\n  }\n":
      TadaDocumentNode<{ bonds: { id: string; name: string | null; symbol: string | null; decimals: number; totalSupply: string; isMatured: boolean; maturityDate: string; paused: boolean; }[]; }, {}, void>;
