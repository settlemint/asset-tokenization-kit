...
PREDEPLOYED_TOKENIZED_DEPOSIT_FACTORY_ADDRESS="0x5e771e1417100000000000000000000000000007"
...
if [ ! -f "$DEPLOYED_ADDRESSES_PATH" ]; then
    ...
    TOKENIZED_DEPOSIT_FACTORY_ADDRESS="$PREDEPLOYED_TOKENIZED_DEPOSIT_FACTORY_ADDRESS"
else
    ...
    TOKENIZED_DEPOSIT_FACTORY_ADDRESS=$(jq -r '."TokenizedDepositFactoryModule#TokenizedDepositFactory"' "$DEPLOYED_ADDRESSES_PATH")
fi
...
export const TOKENIZED_DEPOSIT_FACTORY_ADDRESS = '$TOKENIZED_DEPOSIT_FACTORY_ADDRESS' as Address
" > "$CONTRACTS_PATH"
