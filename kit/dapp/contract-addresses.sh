...
PREDEPLOYED_DEPOSIT_FACTORY_ADDRESS="0x5e771e1417100000000000000000000000000007"
PREDEPLOYED_XVP_SETTLEMENT_FACTORY_ADDRESS="0x5e771e1417100000000000000000000000000008"
PREDEPLOYED_SMART_DEPLOYMENT_REGISTRY_ADDRESS="0x5e771e141710000000000000000000000000000b" # TODO: replace with actual predeployed address (not done yet in btp)
...
if [ ! -f "$DEPLOYED_ADDRESSES_PATH" ]; then
    ...
    DEPOSIT_FACTORY_ADDRESS="$PREDEPLOYED_DEPOSIT_FACTORY_ADDRESS"
    XVP_SETTLEMENT_FACTORY_ADDRESS="$PREDEPLOYED_XVP_SETTLEMENT_FACTORY_ADDRESS"
    SMART_DEPLOYMENT_REGISTRY_ADDRESS="$PREDEPLOYED_SMART_DEPLOYMENT_REGISTRY_ADDRESS"
else
    ...
    DEPOSIT_FACTORY_ADDRESS=$(jq -r '."DepositFactoryModule#DepositFactory"' "$DEPLOYED_ADDRESSES_PATH")
    XVP_SETTLEMENT_FACTORY_ADDRESS=$(jq -r '."XvPSettlementFactoryModule#XvPSettlementFactory"' "$DEPLOYED_ADDRESSES_PATH")
    SMART_DEPLOYMENT_REGISTRY_ADDRESS=$(jq -r '."DeploymentRegistryModule#SMARTDeploymentRegistry"' "$DEPLOYED_ADDRESSES_PATH")
fi
...
export const DEPOSIT_FACTORY_ADDRESS = '$DEPOSIT_FACTORY_ADDRESS' as Address
export const XVP_SETTLEMENT_FACTORY_ADDRESS = '$XVP_SETTLEMENT_FACTORY_ADDRESS' as Address
export const SMART_DEPLOYMENT_REGISTRY_ADDRESS = '$SMART_DEPLOYMENT_REGISTRY_ADDRESS' as Address
" > "$CONTRACTS_PATH"
