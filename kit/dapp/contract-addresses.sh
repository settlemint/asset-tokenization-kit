...
PREDEPLOYED_EAS_REGISTRY_ADDRESS="0x5e771e1417100000000000000000000000000080"
PREDEPLOYED_EAS_ADDRESS="0x5e771e1417100000000000000000000000000081"
PREDEPLOYED_EAS_INDEXER_ADDRESS="0x5e771e1417100000000000000000000000000082"
...
if [ ! -f "$DEPLOYED_ADDRESSES_PATH" ]; then
    ...
    EAS_REGISTRY_ADDRESS="$PREDEPLOYED_EAS_REGISTRY_ADDRESS"
    EAS_ADDRESS="$PREDEPLOYED_EAS_ADDRESS"
    EAS_INDEXER_ADDRESS="$PREDEPLOYED_EAS_INDEXER_ADDRESS"
else
    ...
    EAS_REGISTRY_ADDRESS=$(jq -r '."EASRegistryModule#EASRegistry"' "$DEPLOYED_ADDRESSES_PATH")
    EAS_ADDRESS=$(jq -r '."EASModule#EAS"' "$DEPLOYED_ADDRESSES_PATH")
    EAS_INDEXER_ADDRESS=$(jq -r '."EASIndexerModule#EASIndexer"' "$DEPLOYED_ADDRESSES_PATH")
fi
...
export const EAS_REGISTRY_ADDRESS = '$EAS_REGISTRY_ADDRESS' as Address
export const EAS_ADDRESS = '$EAS_ADDRESS' as Address
export const EAS_INDEXER_ADDRESS = '$EAS_INDEXER_ADDRESS' as Address
" > "$CONTRACTS_PATH"
