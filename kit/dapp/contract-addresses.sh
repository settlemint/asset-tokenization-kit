...
PREDEPLOYED_AIRDROP_FACTORY_ADDRESS="0x5e771e1417100000000000000000000000000009"
...
if [ ! -f "$DEPLOYED_ADDRESSES_PATH" ]; then
    ...
    AIRDROP_FACTORY_ADDRESS="$PREDEPLOYED_AIRDROP_FACTORY_ADDRESS"
else
    ...
    AIRDROP_FACTORY_ADDRESS=$(jq -r '."AirdropFactoryModule#AirdropFactory"' "$DEPLOYED_ADDRESSES_PATH")
fi
...
export const AIRDROP_FACTORY_ADDRESS = '$AIRDROP_FACTORY_ADDRESS' as Address
" > "$CONTRACTS_PATH"
