...
declare module 'gql.tada' {
 interface setupCache {
    "\n  fragment AccessControlFragment on AccessControl {\n    admin { id }\n    registrar { id }\n    claimManager { id }\n    identityIssuer { id }\n    tokenIdentityIssuer { id }\n    tokenIdentityIssuerAdmin { id }\n    deployer { id }\n    storageModifier { id }\n    manageRegistries { id }\n    tokenGovernance { id }\n    supplyManagement { id }\n    custodian { id }\n    emergency { id }\n    implementationManager { id }\n    bypassListManager { id }\n  }\n":
      TadaDocumentNode<{ admin: { id: string; }[]; registrar: { id: string; }[]; claimManager: { id: string; }[]; identityIssuer: unknown; tokenIdentityIssuer: unknown; tokenIdentityIssuerAdmin: unknown; deployer: { id: string; }[]; storageModifier: { id: string; }[]; manageRegistries: { id: string; }[]; tokenGovernance: { id: string; }[]; supplyManagement: { id: string; }[]; custodian: { id: string; }[]; emergency: { id: string; }[]; implementationManager: { id: string; }[]; bypassListManager: { id: string; }[]; }, {}, { fragment: "AccessControlFragment"; on: "AccessControl"; masked: false; }>;
    ...
    "\n  query GetTokenFactories($systemAddress: ID!) {\n    system(id: $systemAddress) {\n      tokenFactoryRegistry {\n        tokenFactories {\n          id\n          name\n          accessControl {\n            ...AccessControlFragment\n          }\n        }\n      }\n    }\n  }\n":
      TadaDocumentNode<{ system: { tokenFactoryRegistry: { tokenFactories: { id: string; name: string; accessControl: { admin: { id: string; }[]; registrar: { id: string; }[]; claimManager: { id: string; }[]; identityIssuer: unknown; tokenIdentityIssuer: unknown; tokenIdentityIssuerAdmin: unknown; deployer: { id: string; }[]; storageModifier: { id: string; }[]; manageRegistries: { id: string; }[]; tokenGovernance: { id: string; }[]; supplyManagement: { id: string; }[]; custodian: { id: string; }[]; emergency: { id: string; }[]; implementationManager: { id: string; }[]; bypassListManager: { id: string; }[]; }; }[]; } | null; } | null; }, { systemAddress: string; }, void>;
    "\n  query ReadTokenQuery($id: ID!) {\n    token(id: $id) {\n      id\n      name\n      symbol\n      decimals\n      requiredClaimTopics {\n        name\n      }\n      accessControl {\n        ...AccessControlFragment\n      }\n    }\n  }\n  ":
      TadaDocumentNode<{ token: { id: string; name: string; symbol: string; decimals: number; requiredClaimTopics: { name: string; }[]; accessControl: { admin: { id: string; }[]; registrar: { id: string; }[]; claimManager: { id: string; }[]; identityIssuer: unknown; tokenIdentityIssuer: unknown; tokenIdentityIssuerAdmin: unknown; deployer: { id: string; }[]; storageModifier: { id: string; }[]; manageRegistries: { id: string; }[]; tokenGovernance: { id: string; }[]; supplyManagement: { id: string; }[]; custodian: { id: string; }[]; emergency: { id: string; }[]; implementationManager: { id: string; }[]; bypassListManager: { id: string; }[]; } | null; } | null; }, { id: string; }, void>;
