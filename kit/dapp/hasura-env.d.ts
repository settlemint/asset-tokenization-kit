...
export type introspection_types = {
  ...
  mutation_root: {
    ...
    name: "mutation_root";
    fields: {
      delete_starterkit_addressbook: {
        name: "delete_starterkit_addressbook";
        type: { kind: "OBJECT"; name: "starterkit_addressbook_mutation_response"; ofType: null };
      };
      ...
      insert_starterkit_addressbook: {
        name: "insert_starterkit_addressbook";
        type: { kind: "OBJECT"; name: "starterkit_addressbook_mutation_response"; ofType: null };
      };
      insert_starterkit_addressbook_one: {
        name: "insert_starterkit_addressbook_one";
        type: { kind: "OBJECT"; name: "starterkit_addressbook"; ofType: null };
      };
      ...
      update_starterkit_addressbook: {
        name: "update_starterkit_addressbook";
        type: { kind: "OBJECT"; name: "starterkit_addressbook_mutation_response"; ofType: null };
      };
      update_starterkit_addressbook_many: {
        name: "update_starterkit_addressbook_many";
        type: {
          kind: "LIST";
          name: never;
          ofType: { kind: "OBJECT"; name: "starterkit_addressbook_mutation_response"; ofType: null };
        };
      };
  ...
  query_root: {
    ...
    name: "query_root";
    fields: {
      starterkit_addressbook: {
        name: "starterkit_addressbook";
        type: {
          kind: "NON_NULL";
          name: never;
          ofType: {
            ...
            ofType: {
              kind: "NON_NULL";
              name: never;
              ofType: { kind: "OBJECT"; name: "starterkit_addressbook"; ofType: null };
            };
          };
        };
      };
      starterkit_addressbook_aggregate: {
        name: "starterkit_addressbook_aggregate";
        type: {
          kind: "NON_NULL";
          name: never;
          ofType: { kind: "OBJECT"; name: "starterkit_addressbook_aggregate"; ofType: null };
        };
      };
      starterkit_wallets: {
  ...
  starterkit_addressbook: {
    ...
    fields: {
      ...
      id: {
        name: "id";
        type: { kind: "NON_NULL"; name: never; ofType: { kind: "SCALAR"; name: "uuid"; ofType: null } };
      };
      name: {
        name: "name";
        type: { kind: "NON_NULL"; name: never; ofType: { kind: "SCALAR"; name: "String"; ofType: null } };
  ...
  starterkit_addressbook_aggregate: {
    ...
    fields: {
      aggregate: {
        name: "aggregate";
        type: { kind: "OBJECT"; name: "starterkit_addressbook_aggregate_fields"; ofType: null };
      };
      nodes: {
        name: "nodes";
        type: {
  ...
  starterkit_addressbook_aggregate_fields: {
    kind: "OBJECT";
    name: "starterkit_addressbook_aggregate_fields";
    fields: {
      count: {
        name: "count";
        type: { kind: "NON_NULL"; name: never; ofType: { kind: "SCALAR"; name: "Int"; ofType: null } };
      };
      max: { name: "max"; type: { kind: "OBJECT"; name: "starterkit_addressbook_max_fields"; ofType: null } };
      min: { name: "min"; type: { kind: "OBJECT"; name: "starterkit_addressbook_min_fields"; ofType: null } };
    };
  };
  starterkit_addressbook_bool_exp: {
    kind: "INPUT_OBJECT";
    name: "starterkit_addressbook_bool_exp";
    isOneOf: false;
    inputFields: [
      {
        name: "_and";
        type: {
          ...
          ofType: {
            kind: "NON_NULL";
            name: never;
            ofType: { kind: "INPUT_OBJECT"; name: "starterkit_addressbook_bool_exp"; ofType: null };
          };
        };
        defaultValue: null;
      },
      {
        name: "_not";
        type: { kind: "INPUT_OBJECT"; name: "starterkit_addressbook_bool_exp"; ofType: null };
        defaultValue: null;
      },
      {
        name: "_or";
      ...
      { name: "id"; type: { kind: "INPUT_OBJECT"; name: "uuid_comparison_exp"; ofType: null }; defaultValue: null },
  ...
  starterkit_addressbook_insert_input: {
    kind: "INPUT_OBJECT";
    name: "starterkit_addressbook_insert_input";
    isOneOf: false;
    inputFields: [
      { name: "address"; type: { kind: "SCALAR"; name: "String"; ofType: null }; defaultValue: null },
      { name: "id"; type: { kind: "SCALAR"; name: "uuid"; ofType: null }; defaultValue: null },
      { name: "name"; type: { kind: "SCALAR"; name: "String"; ofType: null }; defaultValue: null },
      { name: "walletAddress"; type: { kind: "SCALAR"; name: "String"; ofType: null }; defaultValue: null },
    ];
  };
  starterkit_addressbook_max_fields: {
    kind: "OBJECT";
    name: "starterkit_addressbook_max_fields";
    fields: {
      address: { name: "address"; type: { kind: "SCALAR"; name: "String"; ofType: null } };
      id: { name: "id"; type: { kind: "SCALAR"; name: "uuid"; ofType: null } };
      name: { name: "name"; type: { kind: "SCALAR"; name: "String"; ofType: null } };
      walletAddress: { name: "walletAddress"; type: { kind: "SCALAR"; name: "String"; ofType: null } };
    };
  };
  starterkit_addressbook_min_fields: {
    kind: "OBJECT";
    name: "starterkit_addressbook_min_fields";
    fields: {
      address: { name: "address"; type: { kind: "SCALAR"; name: "String"; ofType: null } };
      id: { name: "id"; type: { kind: "SCALAR"; name: "uuid"; ofType: null } };
      name: { name: "name"; type: { kind: "SCALAR"; name: "String"; ofType: null } };
  ...
  starterkit_addressbook_mutation_response: {
    kind: "OBJECT";
    name: "starterkit_addressbook_mutation_response";
    fields: {
      affected_rows: {
        name: "affected_rows";
        type: { kind: "NON_NULL"; name: never; ofType: { kind: "SCALAR"; name: "Int"; ofType: null } };
  ...
  starterkit_addressbook_order_by: {
    kind: "INPUT_OBJECT";
    name: "starterkit_addressbook_order_by";
    isOneOf: false;
    inputFields: [
      { name: "address"; type: { kind: "ENUM"; name: "order_by"; ofType: null }; defaultValue: null },
      ...
      { name: "walletAddress"; type: { kind: "ENUM"; name: "order_by"; ofType: null }; defaultValue: null },
    ];
  };
  starterkit_addressbook_select_column: {
    name: "starterkit_addressbook_select_column";
    enumValues: "address" | "id" | "name" | "walletAddress";
  };
  starterkit_addressbook_set_input: {
    kind: "INPUT_OBJECT";
    name: "starterkit_addressbook_set_input";
    isOneOf: false;
    inputFields: [
      { name: "address"; type: { kind: "SCALAR"; name: "String"; ofType: null }; defaultValue: null },
      { name: "id"; type: { kind: "SCALAR"; name: "uuid"; ofType: null }; defaultValue: null },
  ...
  starterkit_addressbook_stream_cursor_input: {
    kind: "INPUT_OBJECT";
    name: "starterkit_addressbook_stream_cursor_input";
    isOneOf: false;
    inputFields: [
      {
        name: "initial_value";
        type: {
          kind: "NON_NULL";
          name: never;
          ofType: { kind: "INPUT_OBJECT"; name: "starterkit_addressbook_stream_cursor_value_input"; ofType: null };
        };
        defaultValue: null;
      },
  ...
  starterkit_addressbook_stream_cursor_value_input: {
    kind: "INPUT_OBJECT";
    name: "starterkit_addressbook_stream_cursor_value_input";
    isOneOf: false;
    inputFields: [
      { name: "address"; type: { kind: "SCALAR"; name: "String"; ofType: null }; defaultValue: null },
      { name: "id"; type: { kind: "SCALAR"; name: "uuid"; ofType: null }; defaultValue: null },
  ...
  starterkit_addressbook_updates: {
    kind: "INPUT_OBJECT";
    name: "starterkit_addressbook_updates";
    isOneOf: false;
    inputFields: [
      {
        name: "_set";
        type: { kind: "INPUT_OBJECT"; name: "starterkit_addressbook_set_input"; ofType: null };
        defaultValue: null;
      },
      {
        name: "where";
  ...
  subscription_root: {
    ...
    fields: {
      ...
      starterkit_addressbook_stream: {
        name: "starterkit_addressbook_stream";
        type: {
          kind: "NON_NULL";
          name: never;
          ofType: {
  ...
  uuid_comparison_exp: {
    ...
    isOneOf: false;
    inputFields: [
      { name: "_eq"; type: { kind: "SCALAR"; name: "uuid"; ofType: null }; defaultValue: null },
      { name: "_gt"; type: { kind: "SCALAR"; name: "uuid"; ofType: null }; defaultValue: null },
      { name: "_gte"; type: { kind: "SCALAR"; name: "uuid"; ofType: null }; defaultValue: null },
      {
        name: "_in";
        type: {
          kind: "LIST";
          name: never;
          ofType: { kind: "NON_NULL"; name: never; ofType: { kind: "SCALAR"; name: "uuid"; ofType: null } };
        };
        defaultValue: null;
      },
      { name: "_is_null"; type: { kind: "SCALAR"; name: "Boolean"; ofType: null }; defaultValue: null },
      { name: "_lt"; type: { kind: "SCALAR"; name: "uuid"; ofType: null }; defaultValue: null },
      { name: "_lte"; type: { kind: "SCALAR"; name: "uuid"; ofType: null }; defaultValue: null },
      { name: "_neq"; type: { kind: "SCALAR"; name: "uuid"; ofType: null }; defaultValue: null },
      {
        name: "_nin";
        type: {
          kind: "LIST";
